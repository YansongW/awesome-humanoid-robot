...
type: component
names:
  en: Harmonic Drive Advances Surgical Robotics Supply With Innovative LPA 20 Compact
...
summary:
  ...
  zh: Harmonic Drive's launch of the LPA 20 integrated servo actuator strengthens
    the company's position as a top supplier of surgical robotic motion control components,
    delivering precision and a compact design to address critical challenges for original
    equipment manufacturers (OEMs).
...
- id: src_001
  type: website
  title: Harmonic Drive Advances Surgical Robotics Supply With Innovative LPA 20 Compact
    Actuator Control Component
