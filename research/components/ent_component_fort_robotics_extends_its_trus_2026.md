...
type: component
names:
  en: FORT Robotics extends its Trust Layer for Physical AI by adding Outside-In Safety
...
- id: src_001
  type: website
  title: FORT Robotics extends its Trust Layer for Physical AI by adding Outside-In
    Safety in collaboration with NVIDIA Halos for Robotics
