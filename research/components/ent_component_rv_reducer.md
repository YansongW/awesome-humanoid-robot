...
verification:
  ...
  confidence: high
  notes: Body backfilled from chapter-04.md#4.3.3 行星减速器与摆线减速器 by scripts/backfill_nonpaper_entries.py.
sources:
...
---
## 概述
RV减速器是人形机器人领域的重要component。以下内容整理自项目 Wiki，供深入查阅。
...
## 参考
- Wiki extraction
- 项目 Wiki：chapter-04.md#4.3.3 行星减速器与摆线减速器
