...
summary:
  ...
  ko: LangWBC는 먼저 언어 명령, 본체 상태와 관절 시퀀스, 시뮬레이션 상호작용 데이터로부터 장면, 목표 또는 운동 표현을 복구한 다음, 교사-학생 지식 전이, PPO/RL 정책
    훈련, 확산 정책/흐름 매칭을 통한 전신 궤적/동작 시퀀스 생성, 저수준 제어기 목표를 수행한다. 핵심은 특권 정보를 사용해 교사 정책을 훈련하고, 그 능력을 배포 관측만 사용할
