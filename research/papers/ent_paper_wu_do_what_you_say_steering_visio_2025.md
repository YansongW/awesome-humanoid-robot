...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: SEAL. Institution: University
    of Utah, NVIDIA. arXiv: 2510.16281.'
sources:
- id: src_001
  type: paper
  title: 'Do What You Say: Steering Vision-Language-Action Models via Runtime Reasoning-Action
    Alignment Verification (arXiv)'
