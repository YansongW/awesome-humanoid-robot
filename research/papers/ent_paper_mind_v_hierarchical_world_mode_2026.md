...
type: paper
names:
  en: 'MIND-V: Hierarchical World Model for Long-Horizon Robotic Manipulation with
...
- id: src_001
  type: paper
  title: 'MIND-V: Hierarchical World Model for Long-Horizon Robotic Manipulation with
    RL-based Physical Alignment (arXiv)'
