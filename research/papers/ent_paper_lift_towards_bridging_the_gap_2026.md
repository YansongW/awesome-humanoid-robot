...
names:
  en: 'LIFT: Towards Bridging the Gap between Large-Scale Pretraining and Efficient
    Finetuning for Humanoid Control'
  zh: LIFT：用大批量 SAC 预训练 + 物理先验世界模型微调，把人形 sim-to-real 压到 1 小时
  ko: 'LIFT: Towards Bridging the Gap between Large-Scale Pretraining and Efficient
    Finetuning for Humanoid Control'
summary:
  en: ''
...
verification:
  ...
  notes: 'Imported from Humanoid_Robot_Learning_Paper_Notebooks progress.json. Folder:
    papers/10_Sim-to-Real/LIFT__Towards_Bridging_the_Gap_between_Large-Scale_Pretraining_and_Efficient_F.
    Route: Sim-to-Real.'
sources:
- id: src_001
  type: website
  title: 'LIFT: Towards Bridging the Gap between Large-Scale Pretraining and Efficient
    Finetuning for Humanoid Control'
  url: ''
  date: '2026'
