...
summary:
  ...
  zh: 'Diffusion-VLA: Scaling Robot Foundation Models via Unified Diffusion and Autoregression
    (Diffusion-VLA), is a 2024 large vision-language-action model for robotic manipulation,
    introduced by East China Normal University, Midea Group, Shanghai University,
    and published at ICML25.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Diffusion-VLA. Institution:
    East China Normal University, Midea Group, Shanghai University. Venue: ICML25.
    arXiv: 2412.03293.'
sources:
- id: src_001
  type: paper
  title: 'Diffusion-VLA: Scaling Robot Foundation Models via Unified Diffusion and
    Autoregression (arXiv)'
