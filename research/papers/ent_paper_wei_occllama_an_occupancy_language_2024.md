...
summary:
  ...
  zh: 'OccLLaMA: An Occupancy-Language-Action Generative World Model for Autonomous
    Driving (OccLLaMA), is a 2024 large vision-language-action model for robotic manipulation,
    introduced by Academy for Engineering & Technology, Fudan University, Institute
    for AI Industry Research, Tsinghua University.'
  ko: 'OccLLaMA: An Occupancy-Language-Action Generative World Model for Autonomous
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: OccLLaMA. Institution: Academy
    for Engineering & Technology, Fudan University, Institute for AI Industry Research,
    Tsinghua University. arXiv: 2409.03272.'
sources:
- id: src_001
  type: paper
