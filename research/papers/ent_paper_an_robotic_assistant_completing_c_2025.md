...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Robotic Assistant. Institution:
    ETH Zurich, MIT, Stanford University. arXiv: 2510.25713.'
sources:
- id: src_001
  type: paper
  title: 'Robotic Assistant: Completing Collaborative Tasks with Dexterous Vision-Language-Action
    Models (arXiv)'
