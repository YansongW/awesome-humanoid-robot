...
summary:
  ...
  zh: 'Impromptu VLA: Open Weights and Open Data for Driving Vision-Language-Action
    Models (Impromptu VLA), is a 2025 large vision-language-action model for robotic
    manipulation, introduced by AIR, Tsinghua University, Bosch Research, IIIS, Tsinghua
    University, and published at NIPS25.'
  ko: 'Impromptu VLA: Open Weights and Open Data for Driving Vision-Language-Action
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Impromptu VLA. Institution:
    AIR, Tsinghua University, Bosch Research, IIIS, Tsinghua University. Venue: NIPS25.
    arXiv: 2505.23757.'
sources:
- id: src_001
  type: paper
  title: 'Impromptu VLA: Open Weights and Open Data for Driving Vision-Language-Action
    Models (arXiv)'
