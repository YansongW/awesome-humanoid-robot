...
summary:
  ...
  zh: Correcting Robot Plans with Natural Language Feedback (Language costs), is a
    2022 generalized vision-language-action model for robotic manipulation, introduced
    by NVIDIA, MIT, University of Utah, University of Washington, and published at
    Robotics - Science and Systems 2022.
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Language costs. Institution:
    NVIDIA, MIT, University of Utah, University of Washington. Venue: Robotics - Science
    and Systems 2022.'
sources:
- id: src_001
  type: website
