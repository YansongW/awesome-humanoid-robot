...
summary:
  en: Embodied CoT Distillation From LLM To Off-the-shelf Agents (Embodied CoT Distillation
    ...
    2024.
  zh: Embodied CoT Distillation From LLM To Off-the-shelf Agents (Embodied CoT Distillation
    From LLM To Off-the-shelf Agents), is a 2024 large vision-language-action model
    for robotic manipulation, introduced by Sungkyunkwan University, Department of
    Computer Science and Engineering, Sungkyunkwan University, and published at ICML
    2024.
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Embodied CoT Distillation
    From LLM To Off-the-shelf Agents. Institution: Sungkyunkwan University, Department
    of Computer Science and Engineering, Sungkyunkwan University. Venue: ICML 2024.'
sources:
- id: src_001
  type: paper
