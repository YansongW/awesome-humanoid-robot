...
names:
  ...
  ko: 'CEER: Compliant End-Effector and Root Control as a Unified Interface for Hierarchical
    Humanoid Loco-Manipulation'
summary:
  en: ''
...
verification:
  ...
  confidence: low
  notes: 'Imported from WeChat curated list (033). Institution: . Full title: CEER:
    Compliant End-Effector and Root Control as a Unified Interface for Hierarchical
    Humanoid Loco-Manipulation.'
sources:
- id: src_001
  type: website
