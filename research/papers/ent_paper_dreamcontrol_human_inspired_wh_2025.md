...
verification:
  ...
  confidence: low
  notes: 'Imported from WeChat curated list (093). Institution: . Full title: DreamControl:
    Human-Inspired Whole-Body Humanoid Control for Scene Interaction via Guided Diffusion.'
sources:
- id: src_001
  type: website
