...
type: paper
names:
  en: StemVLA:An Open-Source Vision-Language-Action Model with Future 3D Spatial Geometry
...
- id: src_001
  type: paper
  title: StemVLA:An Open-Source Vision-Language-Action Model with Future 3D Spatial
    Geometry Knowledge and 4D Historical Representation
