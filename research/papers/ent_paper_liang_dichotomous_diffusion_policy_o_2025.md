...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: DIPOLE. Institution: Institute
    for AI Industry Research (AIR), Tsinghua University, Institute for AI Industry
    Research. arXiv: 2601.00898.'
sources:
- id: src_001
  type: paper
