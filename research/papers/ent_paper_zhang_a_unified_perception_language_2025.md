...
summary:
  ...
  zh: A Unified Perception-Language-Action Framework for Adaptive Autonomous Driving
    (PLA), is a 2025 large vision-language-action model for robotic manipulation,
    introduced by Technical University of Munich, Chair of Robotics, Artificial Intelligence
    and Embedded Systems.
  ko: A Unified Perception-Language-Action Framework for Adaptive Autonomous Driving
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: PLA. Institution: Technical
    University of Munich, Chair of Robotics, Artificial Intelligence and Embedded
    Systems. arXiv: 2507.23540.'
sources:
- id: src_001
  type: paper
