...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: TacRefineNet. Institution:
    Xiaomi Robotics. arXiv: 2509.25746.'
sources:
- id: src_001
  type: paper
  title: 'TacRefineNet: Tactile-Only Grasp Refinement Between Arbitrary In-Hand Object
    Poses (arXiv)'
