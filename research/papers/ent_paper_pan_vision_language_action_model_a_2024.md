...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Vision-Language-Action Model
    and Diffusion Policy Switching Enables Dexterous Control of an Anthropomorphic
    Hand. Institution: Swiss Federal Institute of Technology Lausanne. arXiv: 2410.14022.'
sources:
- id: src_001
  type: paper
  title: Vision-Language-Action Model and Diffusion Policy Switching Enables Dexterous
    Control of an Anthropomorphic Hand (arXiv)
...
- id: src_002
  type: website
  title: Vision-Language-Action Model and Diffusion Policy Switching Enables Dexterous
    Control of an Anthropomorphic Hand source
