...
summary:
  ...
  zh: 'AgentWorld: An Interactive Simulation Platform for Scene Construction and Mobile
    Robotic Manipulation (AgentWorld), is a 2025 large vision-language-action model
    for robotic manipulation, introduced by Tencent Robotics X, Shanghai Jiao Tong
    University, and published at CoRL25.'
  ko: 'AgentWorld: An Interactive Simulation Platform for Scene Construction and Mobile
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: AgentWorld. Institution:
    Tencent Robotics X, Shanghai Jiao Tong University. Venue: CoRL25. arXiv: 2508.07770.'
sources:
- id: src_001
  type: paper
  title: 'AgentWorld: An Interactive Simulation Platform for Scene Construction and
    Mobile Robotic Manipulation (arXiv)'
