...
summary:
  en: 'Hiking in the Wild: A Scalable Perceptive Parkour Framework for Humanoids is
    a knowledge node related to paper in the humanoid robot value chain.'
  zh: ''
  ko: 'Hiking in the Wild: A Scalable Perceptive Parkour Framework for Humanoids is
    a knowledge node related to paper in the humanoid robot value chain.'
domains:
...
verification:
  ...
  confidence: medium
  notes: 'Imported from WeChat curated list (024). Institution: 清华大学交叉信息研究院；上海期智研究院；清华大学计算机系.
    arXiv: 2601.07718.'
sources:
- id: src_001
  type: paper
...
## 概述
Hiking in the Wild: A Scalable Perceptive Parkour Framework for Humanoids is a knowledge node related to paper in the humanoid robot value chain.
