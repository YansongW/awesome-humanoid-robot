...
summary:
  en: 'Long-VLA: Unleashing Long-Horizon Capability of Vision Language Action Model
    ...
    CoRL25.'
  zh: 'Long-VLA: Unleashing Long-Horizon Capability of Vision Language Action Model
    for Robot Manipulation (Long-VLA), is a 2025 large vision-language-action model
    for robotic manipulation, introduced by Zhejiang University, and published at
    CoRL25.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Long-VLA. Institution: Zhejiang
    University. Venue: CoRL25. arXiv: 2508.19958.'
sources:
- id: src_001
  type: paper
  title: 'Long-VLA: Unleashing Long-Horizon Capability of Vision Language Action Model
    for Robot Manipulation (arXiv)'
