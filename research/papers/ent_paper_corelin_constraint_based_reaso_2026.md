...
summary:
  en: "arXiv:2602.20055v2 Announce Type: replace \nAbstract: Robot navigation typically assumes an obstacle-free path exists\
    ...
    \ We propose CoReLIN, an LLM-driven constraint-based reasoning framework with active perception. CoReLIN reasons over\
    \ a structured scene graph to decide which objects to relocate, where to place them, and where to explore next. A standard\
  ...
  zh: "arXiv:2602.20055v2 Announce Type: replace \nAbstract: Robot navigation typically assumes an obstacle-free path exists\
    ...
    \ optimality, captured by Price of Clutter. In ProcTHOR-10k, CoReLIN outperforms best baseline by 16% under standard metrics\
    \ and LES, and transfers to real-world hardware."
  ko: "arXiv:2602.20055v2 Announce Type: replace \nAbstract: Robot navigation typically assumes an obstacle-free path exists\
    \ between start and goal. In real environments, however, clutter may block all routes. We introduce Lifelong Interactive\
    \ Navigation, where a mobile robot with manipulation capabilities must move objects to forge paths and complete sequential\
    \ object-placement tasks. Because environment modifications persist, decisions impact future navigability and task difficulty.\
    \ We propose CoReLIN, an LLM-driven constraint-based reasoning framework with active perception. CoReLIN reasons over\
...
verification:
  ...
  confidence: medium
  notes: Abstract backfilled by scripts/backfill_paper_abstracts.py from http://arxiv.org/abs/2602.20055v2.
sources:
- id: src_001
  type: paper
