...
summary:
  en: "arXiv:2603.06121v2 Announce Type: replace \nAbstract: Gaze and speech are promising interaction modalities for individuals\
...
verification:
  ...
  confidence: medium
  notes: Abstract backfilled by scripts/backfill_paper_abstracts.py from http://arxiv.org/abs/2603.06121v2.
sources:
- id: src_001
  type: paper
