...
summary:
  ...
  zh: 'Focusing on What Matters: Object-Agent-centric Tokenization for Vision Language
    Action models (Oat-VLA), is a 2025 large vision-language-action model for robotic
    manipulation, introduced by Centre for Artificial Intelligence, UCL, Qualcomm
    AI Research, and published at CoRL25.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Oat-VLA. Institution: Centre
    for Artificial Intelligence, UCL, Qualcomm AI Research. Venue: CoRL25. arXiv:
    2509.23655.'
sources:
- id: src_001
  type: paper
