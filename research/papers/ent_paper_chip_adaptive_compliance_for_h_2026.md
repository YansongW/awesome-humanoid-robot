...
summary:
  ...
  ko: CHIP는 본체 상태와 관절 시퀀스, 접촉력/촉각 신호를 추적 가능한 신체 목표로 변환하고, 확산 정책/흐름 매칭, 계층적 스킬/전문가 정책 훈련 또는 전신 정책 조합을 통해
    최종적으로 전신 궤적/동작 시퀀스, 말단 실행기/손목-손 목표, 저수준 제어기 목표를 출력한다. 핵심은 동작 생성을 조건부 생성 문제로 간주하고, 확산 또는 흐름 매칭을 사용하여
