...
summary:
  ...
  zh: 'Grounding Actions in Camera Space: Observation-Centric Vision-Language-Action
    Policy (OC-VLA), is a 2025 large vision-language-action model for robotic manipulation,
    introduced by Zhejiang University, Shanghai AI Lab, SenseTime Research, Nanjing
    University, Tsinghua University.'
  ko: 'Grounding Actions in Camera Space: Observation-Centric Vision-Language-Action
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: OC-VLA. Institution: Zhejiang
    University, Shanghai AI Lab, SenseTime Research, Nanjing University, Tsinghua
    University. arXiv: 2508.13103.'
sources:
- id: src_001
  type: paper
