...
names:
  ...
  ko: 'From Experts to a Generalist: Toward General Whole-Body Control for Humanoid
    Robots'
summary:
  en: ''
...
verification:
  ...
  confidence: low
  notes: 'Imported from WeChat curated list (028). Institution: Peking University.
    Full title: From Experts to a Generalist: Toward General Whole-Body Control for
    Humanoid Robots.'
sources:
- id: src_001
  type: website
