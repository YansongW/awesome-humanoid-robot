...
summary:
  en: 'VLA-AN: An Efficient and Onboard Vision-Language-Action Framework for Aerial
    ...
    Robotics.'
  zh: 'VLA-AN: An Efficient and Onboard Vision-Language-Action Framework for Aerial
    Navigation in Complex Environments (VLA-AN), is a 2025 large vision-language-action
    model for robotic manipulation, introduced by Zhejiang University, Differential
    Robotics.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: VLA-AN. Institution: Zhejiang
    University, Differential Robotics. arXiv: 2512.15258.'
sources:
- id: src_001
  type: paper
  title: 'VLA-AN: An Efficient and Onboard Vision-Language-Action Framework for Aerial
    Navigation in Complex Environments (arXiv)'
