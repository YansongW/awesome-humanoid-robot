...
summary:
  en: "A 2025 VLA system that fuses vision, speech, and environmental sounds to infer user intentions proactively and execute actions without explicit text instructions."
...
verification:
  ...
  confidence: "high"
  notes: "Paper and code retrieved from arXiv and GitHub; dataset statistics from official repository."
...
related_entities:
  ...
  - id: "ent_benchmark_libero_plus"
    relationship: "serves"
    description:
      en: "RoboOmni is related to the broader LIBERO robustness evaluation ecosystem, though primary evaluation uses standard LIBERO."
