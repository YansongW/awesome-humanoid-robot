...
summary:
  ...
  zh: 'RT-1: Robotics Transformer for Real-World Control at Scale (RT-1), is a 2022
    generalized vision-language-action model for robotic manipulation, introduced
    by Robotics at Google, Everyday Robots, Google Research, Brain Team, and published
    at Robotics - Science and Systems 2022.'
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: RT-1. Institution: Robotics
    at Google, Everyday Robots, Google Research, Brain Team. Venue: Robotics - Science
    and Systems 2022.'
sources:
- id: src_001
  type: website
