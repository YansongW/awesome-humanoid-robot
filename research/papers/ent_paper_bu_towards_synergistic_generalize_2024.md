...
summary:
  en: Towards Synergistic, Generalized, and Efficient Dual-System for Robotic Manipulation
    ...
    Shanghai AI Lab.
  zh: Towards Synergistic, Generalized, and Efficient Dual-System for Robotic Manipulation
    (RoboDual), is a 2024 large vision-language-action model for robotic manipulation,
    introduced by Shanghai Jiao Tong Univeristy, The University of Hong Kong, AgiBot,
    Shanghai AI Lab.
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: RoboDual. Institution: Shanghai
    Jiao Tong Univeristy, The University of Hong Kong, AgiBot, Shanghai AI Lab. arXiv:
    2410.08001.'
sources:
- id: src_001
  type: paper
