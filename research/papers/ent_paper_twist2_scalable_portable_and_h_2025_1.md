...
names:
  ...
  ko: ''
summary:
  en: TWIST2 的实现路径是先把相机图像/多视角观测、人类视频/动捕轨迹、遥操作/外骨骼数据编码成多模态表征，再用ACT/行为克隆模仿学习、VLA 多模态动作模型、全身控制器/WBC/MPC预测可执行动作命令。关键点是保留
...
verification:
  ...
  confidence: low
  notes: 'Imported from WeChat curated list (132). Institution: Stanford University、UC
