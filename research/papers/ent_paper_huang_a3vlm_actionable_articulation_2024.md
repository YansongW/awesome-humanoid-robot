...
summary:
  en: 'A3VLM: Actionable Articulation-Aware Vision Language Model (A3VLM), is a 2024
    ...
    at CoRL24.'
  zh: 'A3VLM: Actionable Articulation-Aware Vision Language Model (A3VLM), is a 2024
    large vision-language-action model for robotic manipulation, introduced by SJTU,
    Shanghai AI Lab, Rutgers University, Yuandao AI, PKU, CUHK MMLab, and published
    at CoRL24.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: A3VLM. Institution: SJTU,
    Shanghai AI Lab, Rutgers University, Yuandao AI, PKU, CUHK MMLab. Venue: CoRL24.'
sources:
- id: src_001
  type: paper
  title: A3VLM source
