...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Mechanistic Finetuning of
    Vision-Language-Action Models via Few-Shot Demonstrations. Institution: Carnegie
    Mellon University, University of Southern California, University of California,
    Berkeley, MIT-IBM Watson AI Lab. arXiv: 2511.22697.'
sources:
- id: src_001
  type: paper
