...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Dual-Stream Diffusion for
    World-Model Augmented Vision-Language-Action Model. Institution: KAIST, RLWRLD.
    arXiv: 2510.27607.'
sources:
- id: src_001
  type: paper
