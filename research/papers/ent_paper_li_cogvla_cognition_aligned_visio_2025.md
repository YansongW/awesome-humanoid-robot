...
summary:
  en: 'CogVLA: Cognition-Aligned Vision-Language-Action Model via Instruction-Driven
    ...
    at NIPS25.'
  zh: 'CogVLA: Cognition-Aligned Vision-Language-Action Model via Instruction-Driven
    Routing & Sparsification (CogVLA), is a 2025 large vision-language-action model
    for robotic manipulation, introduced by School of Computer Science and Technology,
    Harbin Institute of Technology, Harbin Institute of Technology, and published
    at NIPS25.'
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: CogVLA. Institution: School
    of Computer Science and Technology, Harbin Institute of Technology, Harbin Institute
    of Technology. Venue: NIPS25. arXiv: 2508.21046.'
sources:
- id: src_001
  type: paper
  title: 'CogVLA: Cognition-Aligned Vision-Language-Action Model via Instruction-Driven
    Routing & Sparsification (arXiv)'
