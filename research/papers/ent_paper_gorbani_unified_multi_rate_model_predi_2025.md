...
---
## 概述
该研究针对喷气动力飞行人形机器人iRonCub，设计了一种新颖的MPC框架。控制器基于线性化的质心动量模型描述飞行动力学，并引入二阶非线性模型显式处理喷气推进的慢速与非线性特性。核心创新在于多速率MPC公式，它能够协调机器人关节与喷气发动机的不同执行速率，同时将喷气动力学直接融入预测模型。通过MuJoCo仿真，该框架展示了机器人从外部扰动中恢复以及执行稳定、非突变飞行动作的能力。

## 核心内容
### 方法
- 提出一种多速率MPC框架，用于喷气动力飞行人形机器人iRonCub。
- 控制器基于线性化的质心动量模型，以表示飞行动力学。
- 引入二阶非线性模型，显式处理喷气推进的慢速与非线性动力学。

### 架构
- 多速率MPC公式：处理机器人关节与喷气发动机的不同执行速率。
- 将喷气动力学直接嵌入预测模型，实现联合优化。

### 实验设置
- 使用喷气动力人形机器人iRonCub进行验证。
- 仿真环境：MuJoCo。
...
### 结论
该多速率MPC框架成功解决了喷气动力人形机器人在飞行控制中面临的执行速率差异与非线性动力学挑战，为实际应用提供了理论基础。
