...
names:
  ...
  ko: 'SynAgent: Generalizable Cooperative Humanoid Manipulation via Solo-to-Cooperative
    Agent Synergy'
summary:
  en: ''
...
verification:
  ...
  confidence: low
  notes: 'Imported from WeChat curated list (079). Institution: . Full title: SynAgent:
    Generalizable Cooperative Humanoid Manipulation via Solo-to-Cooperative Agent
    Synergy.'
sources:
- id: src_001
  type: website
