...
summary:
  ...
  zh: Learning Universal Policies via Text-Guided Video Generation (UniPi), is a 2023
    generalized vision-language-action model for robotic manipulation, introduced
    by MIT, Google DeepMind, UC Berkeley, Georgia Tech, University of Alberta, and
    published at NIPS 2023.
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: UniPi. Institution: MIT,
    Google DeepMind, UC Berkeley, Georgia Tech, University of Alberta. Venue: NIPS
    2023.'
sources:
- id: src_001
  type: website
