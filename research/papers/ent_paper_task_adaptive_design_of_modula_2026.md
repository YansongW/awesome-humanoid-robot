...
summary:
  en: "arXiv:2607.09548v1 Announce Type: new \nAbstract: Aerial manipulation with multirotor platforms enables physical interaction\
    \ in complex environments, but rotor-induced airflow remains a critical limitation for tasks involving airflow-sensitive\
    \ targets or surroundings. This paper presents an optimization-based design framework for modular aerial manipulators\
    \ that jointly considers task wrench feasibility, end-effector placement, and airflow exposure constraints. We first introduce\
    ...
    \ together with the platform configuration. Scalability experiments and ablation studies validate the effectiveness of\
  ...
  zh: "arXiv:2607.09548v1 Announce Type: new \nAbstract: Aerial manipulation with multirotor platforms enables physical interaction\
    ...
    \ together with the platform configuration. Scalability experiments and ablation studies validate the effectiveness of\
    \ the proposed framework."
  ko: "arXiv:2607.09548v1 Announce Type: new \nAbstract: Aerial manipulation with multirotor platforms enables physical interaction\
    \ in complex environments, but rotor-induced airflow remains a critical limitation for tasks involving airflow-sensitive\
    \ targets or surroundings. This paper presents an optimization-based design framework for modular aerial manipulators\
    \ that jointly considers task wrench feasibility, end-effector placement, and airflow exposure constraints. We first introduce\
    \ a novel categorization of target-side airflow tolerance and formulate the corresponding exposure requirements as geometric\
...
verification:
  ...
  confidence: medium
  notes: Abstract backfilled by scripts/backfill_paper_abstracts.py from http://arxiv.org/abs/2607.09548v1.
sources:
- id: src_001
  type: paper
