...
summary:
  en: "arXiv:2605.02347v2 Announce Type: replace \nAbstract: Humans grasp unfamiliar objects by combining an initial visual\
    ...
    \ a real-world grasp. We achieved superior results over baselines for both grippers (grasp success rate of 84% with a\
    \ three-finger gripper and 91% with a two-finger gripper), while improving the 3D shape reconstruction quality in all\
