...
summary:
  en: 'MindDrive: A Vision-Language-Action Model for Autonomous Driving via Online
    ...
    Xiaomi EV.'
  zh: 'MindDrive: A Vision-Language-Action Model for Autonomous Driving via Online
    Reinforcement Learning (MindDrive), is a 2025 large vision-language-action model
    for robotic manipulation, introduced by Huazhong University of Science and Technology,
    Xiaomi EV.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: MindDrive. Institution: Huazhong
    University of Science and Technology, Xiaomi EV. arXiv: 2512.13636.'
sources:
- id: src_001
  type: paper
