...
summary:
  ...
  zh: 'OmniJARVIS: Unified Vision-Language-Action Tokenization Enables Open-World
    Instruction Following Agents (OmniJARVIS), is a 2024 large vision-language-action
    model for robotic manipulation, introduced by Peking University, The Chinese University
    of Hong Kong, Shenzhen, and published at NIPS24.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: OmniJARVIS. Institution:
    Peking University, The Chinese University of Hong Kong, Shenzhen. Venue: NIPS24.'
sources:
- id: src_001
  type: website
