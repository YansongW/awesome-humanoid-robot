...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: VLA-R. Institution: KAIST.
    arXiv: 2511.12405.'
sources:
- id: src_001
  type: paper
  title: 'VLA-R: Vision-Language Action Retrieval toward Open-World End-to-End Autonomous
    Driving (arXiv)'
