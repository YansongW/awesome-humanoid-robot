...
summary:
  ...
  ko: 'Thinking in 360°: Humanoid Visual Search in the Wild는 휴머노이드 로보틱스의 내비게이션에 관한 논문입니다.'
domains:
...
verification:
  ...
  notes: 'Structured body generated by scripts/backfill_critical_paper_bodies.py via DeepSeek API from entry metadata. | WP3
    marker fix 2026-08-10: summary.ko translated en->ko (DeepSeek). | WP3 2026-08-06: merged ent_paper_thinking_in_360_humanoid_visua_2026
    into this card. Reason: G18 same paper: arXiv 2511.20351 title matches 2026 card (with degree sign); keeper richer (6680
    vs 3674).. Manifest: .staging/cleanup_wp12/manifest_wp3_merges.json'
sources:
- id: src_001
  type: website
