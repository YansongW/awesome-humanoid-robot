...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: FlowVLA. Institution: HKUST(GZ),
    Shanghai Jiao Tong University. arXiv: 2508.18269.'
sources:
- id: src_001
  type: paper
  title: 'FlowVLA: Visual Chain of Thought-based Motion Reasoning for Vision-Language-Action
    Models (arXiv)'
