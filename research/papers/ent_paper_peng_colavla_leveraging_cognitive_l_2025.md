...
summary:
  ...
  zh: 'ColaVLA: Leveraging Cognitive Latent Reasoning for Hierarchical Parallel Trajectory
    Planning in Autonomous Driving (ColaVLA), is a 2025 large vision-language-action
    model for robotic manipulation, introduced by Tsinghua University, CUHK MMLab,
    Voyager Research, Didi Chuxing.'
  ko: 'ColaVLA: Leveraging Cognitive Latent Reasoning for Hierarchical Parallel Trajectory
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: ColaVLA. Institution: Tsinghua
    University, CUHK MMLab, Voyager Research, Didi Chuxing. arXiv: 2512.22939.'
sources:
- id: src_001
  type: paper
  title: 'ColaVLA: Leveraging Cognitive Latent Reasoning for Hierarchical Parallel
    Trajectory Planning in Autonomous Driving (arXiv)'
