...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Bi-VLA 2025. Institution:
    The University of Osaka, Kobe University. arXiv: 2509.18865.'
sources:
- id: src_001
  type: paper
  title: 'Bi-VLA: Bilateral Control-Based Imitation Learning via Vision-Language Fusion
    for Action Generation (arXiv)'
