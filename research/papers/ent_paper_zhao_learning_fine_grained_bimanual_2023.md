...
summary:
  en: Learning Fine-Grained Bimanual Manipulation with Low-Cost Hardware (ACT), is
    ...
    and Systems 2023.
  zh: Learning Fine-Grained Bimanual Manipulation with Low-Cost Hardware (ACT), is
    a 2023 generalized vision-language-action model for robotic manipulation, introduced
    by Stanford University, UC Berkeley, Meta, and published at Robotics - Science
    and Systems 2023.
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: ACT. Institution: Stanford
    University, UC Berkeley, Meta. Venue: Robotics - Science and Systems 2023.'
sources:
- id: src_001
  type: website
  title: ACT source
