...
summary:
  en: 'Beyond Success: Refining Elegant Robot Manipulation from Mixed-Quality Data
    ...
    Asia.'
  zh: 'Beyond Success: Refining Elegant Robot Manipulation from Mixed-Quality Data
    via Just-in-Time Intervention (Beyond Success), is a 2025 large vision-language-action
    model for robotic manipulation, introduced by Jilin University, Microsoft Research
    Asia.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Beyond Success. Institution:
    Jilin University, Microsoft Research Asia. arXiv: 2511.22555.'
sources:
- id: src_001
  type: paper
  title: 'Beyond Success: Refining Elegant Robot Manipulation from Mixed-Quality Data
    via Just-in-Time Intervention (arXiv)'
