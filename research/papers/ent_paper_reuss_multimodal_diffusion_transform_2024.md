...
summary:
  en: 'Multimodal Diffusion Transformer: Learning Versatile Behavior from Multimodal
    ...
    and Systems 2024.'
  zh: 'Multimodal Diffusion Transformer: Learning Versatile Behavior from Multimodal
    Goals (MDT), is a 2024 generalized vision-language-action model for robotic manipulation,
    introduced by Karlsruhe Institute of Technology, and published at Robotics - Science
    and Systems 2024.'
  ko: 'Multimodal Diffusion Transformer: Learning Versatile Behavior from Multimodal
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: MDT. Institution: Karlsruhe
    Institute of Technology. Venue: Robotics - Science and Systems 2024.'
sources:
- id: src_001
  type: website
  title: MDT source
