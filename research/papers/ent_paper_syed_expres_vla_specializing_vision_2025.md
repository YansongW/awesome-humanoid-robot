...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: ExpReS-VLA. Institution:
    Carnegie Mellon University. arXiv: 2511.06202.'
sources:
- id: src_001
  type: paper
  title: 'ExpReS-VLA: Specializing Vision-Language-Action Models Through Experience
    Replay and Retrieval (arXiv)'
