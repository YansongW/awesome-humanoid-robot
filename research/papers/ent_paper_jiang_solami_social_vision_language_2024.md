...
summary:
  ...
  zh: 'SOLAMI: Social Vision-Language-Action Modeling for Immersive Interaction with
    3D Autonomous Characters (SOLAMI), is a 2024 large vision-language-action model
    for robotic manipulation, introduced by SenseTime Research, S-Lab, Nanyang Technological
    University, and published at CVPR25.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: SOLAMI. Institution: SenseTime
    Research, S-Lab, Nanyang Technological University. Venue: CVPR25.'
sources:
- id: src_001
  type: website
  title: SOLAMI source
