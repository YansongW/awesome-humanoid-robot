...
summary:
  en: "A 7B-parameter open-source VLA pretrained on 970k real-world robot demonstrations from the Open X-Embodiment dataset, combining Llama 2, DINOv2, and SigLIP for generalist manipulation."
...
verification:
  ...
  confidence: "medium"
  notes: "AI-extracted from arXiv abstract and PDF; key claims (parameter count, dataset size, model architecture) match the source. Human review pending."
