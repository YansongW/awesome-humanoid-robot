...
verification:
  ...
  notes: 'Imported from Humanoid_Robot_Learning_Paper_Notebooks progress.json. Folder:
    papers/06_Manipulation/EgoDemoGen__Egocentric_Demonstration_Generation_for_Viewpoint_Generalization.
    Route: Manipulation.'
sources:
- id: src_001
  type: website
  title: 'EgoDemoGen: Egocentric Demonstration Generation for Viewpoint Generalization
    in Robotic Manipulation'
  url: ''
  date: '2026'
