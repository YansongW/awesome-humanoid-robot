...
summary:
  ...
  zh: Neves、Duarte 和 Neto（2024）使用 KUKA LBR iiwa 7 R800 机器人和 SCHUNK Co-act EGP-C 64 夹爪，对比了人工与机器人辅助的滚筒输送机段装配过程，发现协作模式以装配时间增加约
    15% 为代价，改善了人体工学并降低了心理负荷。
...
verification:
  ...
  confidence: medium
  notes: Abstract backfilled by scripts/backfill_paper_abstracts.py from http://arxiv.org/abs/2403.05306v1.
sources:
- id: src_001
  type: paper
