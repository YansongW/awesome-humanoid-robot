...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Automating Robot Failure
    Recovery Using Vision-Language Models With Optimized Prompts. arXiv: 2409.03966.'
sources:
- id: src_001
  type: paper
  title: Automating Robot Failure Recovery Using Vision-Language Models With Optimized
    Prompts (arXiv)
