...
summary:
  ...
  ko: Design and Control of a Bipedal Robotic Character는 2024년에 발표된, 인간형 로봇의 하드웨어 설계에 관한 연구이다.
domains:
...
verification:
  ...
  notes: 'Structured body generated by scripts/backfill_critical_paper_bodies.py via DeepSeek API from entry metadata. | WP3
    marker fix 2026-08-10: summary.ko translated en->ko (DeepSeek). | WP3 2026-08-06: merged ent_paper_design_and_control_of_a_bipeda_2024
    into this card. Reason: G4 same paper: arXiv 2501.05204 title exact match; keeper body richer (6333 vs 3240).. Manifest:
