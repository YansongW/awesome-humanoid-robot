...
summary:
  ...
  zh: Improving Vision-Language-Action Model with Online Reinforcement Learning (iRe-VLA),
    is a 2025 large vision-language-action model for robotic manipulation, introduced
    by Tsinghua University, University of California, Berkeley, Shanghai Qi Zhi Institute,
    and published at ICRA 2025.
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: iRe-VLA. Institution: Tsinghua
    University, University of California, Berkeley, Shanghai Qi Zhi Institute. Venue:
    ICRA 2025.'
sources:
- id: src_001
  type: website
