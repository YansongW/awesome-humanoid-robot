...
summary:
  ...
  ko: 'Antagonistic Bowden-Cable Actuation of a Lightweight Robotic Hand: Toward Dexterous Manipulation
    for Payload-Constrained Humanoids는 인간형 로봇공학을 위한 하드웨어 설계에 관한 논문입니다.'
domains:
