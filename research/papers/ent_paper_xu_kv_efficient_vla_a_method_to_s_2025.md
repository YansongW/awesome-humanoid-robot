...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: KV-Efficient VLA. Institution:
    University of Toronto, Tsinghua University. arXiv: 2509.21354.'
sources:
- id: src_001
  type: paper
  title: 'KV-Efficient VLA: A Method to Speed up Vision Language Models with RNN-Gated
    Chunked KV Cache (arXiv)'
