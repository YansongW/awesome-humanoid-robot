...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Learning Efficient and Robust
    Language-conditioned Manipulation using Textual-Visual Relevancy and Equivariant
    Language Mapping. Institution: Brown University, Northeastern University. Venue:
    IEEE Robotics Autom. Lett. 2024.'
sources:
- id: src_001
  type: website
  title: Learning Efficient and Robust Language-conditioned Manipulation using Textual-Visual
    Relevancy and Equivariant Language Mapping source
