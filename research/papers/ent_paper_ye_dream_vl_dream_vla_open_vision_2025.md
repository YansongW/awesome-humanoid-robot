...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Dream-VLA. Institution: The
    University of Hong Kong. arXiv: 2512.22615.'
sources:
- id: src_001
  type: paper
  title: 'Dream-VL & Dream-VLA: Open Vision-Language and Vision-Language-Action Models
    with Diffusion Language Model Backbone (arXiv)'
