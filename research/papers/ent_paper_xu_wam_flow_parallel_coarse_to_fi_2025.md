...
summary:
  en: 'WAM-Flow: Parallel Coarse-to-Fine Motion Planning via Discrete Flow Matching
    ...
    Technology Co., Ltd..'
  zh: 'WAM-Flow: Parallel Coarse-to-Fine Motion Planning via Discrete Flow Matching
    for Autonomous Driving (WAM-Flow), is a 2025 large vision-language-action model
    for robotic manipulation, introduced by Fudan University, Yinwang Intelligent
    Technology Co., Ltd..'
  ko: 'WAM-Flow: Parallel Coarse-to-Fine Motion Planning via Discrete Flow Matching
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: WAM-Flow. Institution: Fudan
    University, Yinwang Intelligent Technology Co., Ltd.. arXiv: 2512.06112.'
sources:
- id: src_001
  type: paper
  title: 'WAM-Flow: Parallel Coarse-to-Fine Motion Planning via Discrete Flow Matching
