...
summary:
  ...
  zh: What Matters in Language Conditioned Robotic Imitation Learning over Unstructured
    Data (HULC), is a 2022 generalized vision-language-action model for robotic manipulation,
    introduced by University of Freiburg, University of Technology Nuremberg, and
    published at IEEE Robotics Autom. Lett. 2022.
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: HULC. Institution: University
    of Freiburg, University of Technology Nuremberg. Venue: IEEE Robotics Autom. Lett.
    2022.'
sources:
- id: src_001
  type: website
