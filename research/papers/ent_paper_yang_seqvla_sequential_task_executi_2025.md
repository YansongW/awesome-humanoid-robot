...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: SeqVLA. Institution: Drexel
    University, Virginia Tech. arXiv: 2509.14138.'
sources:
- id: src_001
  type: paper
  title: 'SeqVLA: Sequential Task Execution for Long-Horizon Manipulation with Completion-Aware
    Vision-Language-Action Model (arXiv)'
