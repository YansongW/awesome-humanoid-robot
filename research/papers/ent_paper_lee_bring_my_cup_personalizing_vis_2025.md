...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Bring My Cup Personalizing
    Vision-Language-Action Models with Visual Attentive Prompting. Institution: POSTECH,
    GSAI, IME, dblab. arXiv: 2512.20014.'
sources:
- id: src_001
  type: paper
  title: Bring My Cup Personalizing Vision-Language-Action Models with Visual Attentive
    Prompting (arXiv)
