...
summary:
  ...
  zh: 'MiVLA: Towards Generalizable Vision-Language-Action Model with Human-Robot
    Mutual Imitation Pre-training (MiVLA), is a 2025 large vision-language-action
    model for robotic manipulation, introduced by Tongji University, University of
    Electronic Science and Technology of China.'
  ko: 'MiVLA: Towards Generalizable Vision-Language-Action Model with Human-Robot
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: MiVLA. Institution: Tongji
    University, University of Electronic Science and Technology of China. arXiv: 2512.15411.'
sources:
- id: src_001
  type: paper
  title: 'MiVLA: Towards Generalizable Vision-Language-Action Model with Human-Robot
    Mutual Imitation Pre-training (arXiv)'
