...
verification:
  ...
  notes: 'Imported from Humanoid_Robot_Learning_Paper_Notebooks progress.json. Folder:
    papers/12_Hardware_Design/X2-N__Transformable_Wheel-legged_Humanoid_Robot_with_Dual-mode_Locomotion_and_Manipulation.
    Route: Hardware Design.'
sources:
- id: src_001
  type: website
  title: 'X2-N: A Transformable Wheel-legged Humanoid Robot with Dual-mode Locomotion
    and Manipulation'
  url: ''
  date: '2026'
