...
names:
  ...
  ko: ''
summary:
  en: 这篇工作先把语言指令、相机图像/多视角观测、本体状态与关节序列编码成多模态表征，再用ACT/行为克隆模仿学习、扩散策略/流匹配、VLA 多模态动作模型预测动作
...
verification:
  ...
  confidence: low
  notes: 'Imported from WeChat curated list (159). Institution: NVIDIA. Full title:
