...
summary:
  en: 'CoReVLA: A Dual-Stage End-to-End Autonomous Driving Framework for Long-Tail
    ...
    University.'
  zh: 'CoReVLA: A Dual-Stage End-to-End Autonomous Driving Framework for Long-Tail
    Scenarios via Collect-and-Refine (CoReVLA), is a 2025 large vision-language-action
    model for robotic manipulation, introduced by College of Transportation, Tongji
    University.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: CoReVLA. Institution: College
    of Transportation, Tongji University. arXiv: 2509.15968.'
sources:
- id: src_001
  type: paper
  title: 'CoReVLA: A Dual-Stage End-to-End Autonomous Driving Framework for Long-Tail
    Scenarios via Collect-and-Refine (arXiv)'
