...
summary:
  ...
  zh: 'SQAP-VLA: A Synergistic Quantization-Aware Pruning Framework for High-Performance
    Vision-Language-Action Models (SQAP-VLA), is a 2025 large vision-language-action
    model for robotic manipulation, introduced by School of Electronic Science and
    Engineering, Nanjing University, University of Arizona.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: SQAP-VLA. Institution: School
    of Electronic Science and Engineering, Nanjing University, University of Arizona.
    arXiv: 2509.09090.'
sources:
- id: src_001
  type: paper
