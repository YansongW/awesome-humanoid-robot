...
summary:
  ...
  zh: 'PIVOT: Iterative Visual Prompting Elicits Actionable Knowledge for VLMs (PIVOT),
    is a 2024 generalized vision-language-action model for robotic manipulation, introduced
    by Google DeepMind, Stanford University, The University of Texas at Austin, and
    published at ICML 2024.'
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: PIVOT. Institution: Google
    DeepMind, Stanford University, The University of Texas at Austin. Venue: ICML
    2024.'
sources:
- id: src_001
  type: paper
