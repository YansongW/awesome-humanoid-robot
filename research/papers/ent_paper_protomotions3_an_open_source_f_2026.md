...
summary:
  ...
  ko: 'ProtoMotions3: An Open-source Framework for Humanoid Simulation and Control은 휴머노이드 로보틱스를 위한 시뮬레이션
    플랫폼 및 도구에 관한 논문입니다. ProtoMotions3: 휴머노이드 시뮬레이션 및 제어를 위한 오픈소스 프레임워크.'
domains:
