...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: ImaginationPolicy. arXiv:
    2509.20841.'
sources:
- id: src_001
  type: paper
  title: 'ImaginationPolicy: Towards Generalizable, Precise and Reliable End-to-End
    Policy for Robotic Manipulation (arXiv)'
