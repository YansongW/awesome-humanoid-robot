...
summary:
  en: "arXiv:2606.30988v1 Announce Type: new \nAbstract: Robot manipulation often relies on sensory feedback beyond vision,\
    \ particularly in contact-rich settings where force, tactile, or audio signals reveal interaction states that are not\
    \ directly observable from images. However, these modalities are often hardware- and task-specific, and large-scale multisensory\
    ...
    \ data into pretrained vision-only policies through multi-stage fusion, multisensory future prediction, and experience\
    \ replay over pretraining data. We instantiate MuSe by augmenting a pretrained vision-only policy with force-torque sensing\
    \ and evaluate it on real-world manipulation tasks. Our experiments show that MuSe performs strongly on contact-rich finetuning\
...
verification:
  ...
  confidence: medium
  notes: Abstract backfilled by scripts/backfill_paper_abstracts.py from http://arxiv.org/abs/2606.30988v3.
sources:
- id: src_001
  type: paper
