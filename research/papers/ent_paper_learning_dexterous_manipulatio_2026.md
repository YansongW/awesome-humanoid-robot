...
summary:
  en: "arXiv:2607.00033v1 Announce Type: new \nAbstract: Dexterous robot manipulation can benefit from the abundance of human\
    ...
    \ we represent human and robot motions by the forces and torques they can induce on the object, enabling similarity to\
    \ be measured by the induced instantaneous motions. This guidance makes reinforcement learning more scalable for contact-rich\
...
verification:
  ...
  confidence: medium
  notes: Abstract backfilled by scripts/backfill_paper_abstracts.py from http://arxiv.org/abs/2607.00033v1.
sources:
- id: src_001
  type: paper
