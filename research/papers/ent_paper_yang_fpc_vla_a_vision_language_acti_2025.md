...
summary:
  ...
  zh: 'FPC-VLA: A Vision-Language-Action Framework with a Supervisor for Failure Prediction
    and Correction (FPC-VLA), is a 2025 large vision-language-action model for robotic
    manipulation, introduced by Nankai University, Xiaomi EV, Northeastern University
    Shenyang, University of Macau.'
  ko: 'FPC-VLA: A Vision-Language-Action Framework with a Supervisor for Failure Prediction
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: FPC-VLA. Institution: Nankai
    University, Xiaomi EV, Northeastern University Shenyang, University of Macau.
    arXiv: 2509.04018.'
sources:
- id: src_001
  type: paper
  title: 'FPC-VLA: A Vision-Language-Action Framework with a Supervisor for Failure
    Prediction and Correction (arXiv)'
