...
summary:
  en: "arXiv:2606.31144v1 Announce Type: new \nAbstract: This paper presents an integrated system for the CMU Vision-Language-Action\
    ...
    \ The classified query is then grounded in the geometric and semantic context of the map to generate a detailed prompt\
    \ for the VLM. This yields an actionable output, demonstrating a capable solution for bridging the gap between human language\
    \ and robotic action."
