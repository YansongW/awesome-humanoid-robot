...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: A Joint Modeling of Vision-Language-Action
    for Target-oriented Grasping in Clutter. Institution: Zhejiang University. Venue:
    ICRA23.'
sources:
- id: src_001
  type: website
  title: A Joint Modeling of Vision-Language-Action for Target-oriented Grasping in
    Clutter source
