...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: Modality-Driven Design for
    Multi-Step Dexterous Manipulation. arXiv: 2412.11337.'
sources:
- id: src_001
  type: paper
  title: 'Modality-Driven Design for Multi-Step Dexterous Manipulation: Insights from
    Neuroscience (arXiv)'
