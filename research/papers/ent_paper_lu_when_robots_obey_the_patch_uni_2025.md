...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: UPA-RFAS. Institution: Nanyang
    Technological University, DSO National Laboratories. arXiv: 2511.21192.'
sources:
- id: src_001
  type: paper
  title: 'When Robots Obey the Patch: Universal Transferable Patch Attacks on Vision-Language-Action
    Models (arXiv)'
