...
summary:
  ...
  zh: CRISP -- Compliant ROS2 Controllers for Learning-Based Manipulation Policies
    and Teleoperation (CRISP), is a 2025 large vision-language-action model for robotic
    manipulation, introduced by Technical University of Munich (TUM), TUM School of
    Computation, Information and Technology.
  ko: CRISP -- Compliant ROS2 Controllers for Learning-Based Manipulation Policies
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: CRISP. Institution: Technical
    University of Munich (TUM), TUM School of Computation, Information and Technology.
    arXiv: 2509.06819.'
sources:
- id: src_001
  type: paper
  title: CRISP -- Compliant ROS2 Controllers for Learning-Based Manipulation Policies
    and Teleoperation (arXiv)
