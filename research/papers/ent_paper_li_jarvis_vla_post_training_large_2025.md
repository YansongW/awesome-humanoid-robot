...
summary:
  en: 'JARVIS-VLA: Post-Training Large-Scale Vision Language Models to Play Visual
    ...
    at ACL 2025.'
  zh: 'JARVIS-VLA: Post-Training Large-Scale Vision Language Models to Play Visual
    Games with Keyboards and Mouse (JARVIS-VLA), is a 2025 large vision-language-action
    model for robotic manipulation, introduced by Peking University, and published
    at ACL 2025.'
  ko: ''
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: JARVIS-VLA. Institution:
    Peking University. Venue: ACL 2025.'
sources:
- id: src_001
  type: website
