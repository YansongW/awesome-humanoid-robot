...
summary:
  ...
  zh: 'Affordance Field Intervention: Enabling VLAs to Escape Memory Traps in Robotic
    Manipulation (AFI), is a 2025 large vision-language-action model for robotic manipulation,
    introduced by The University of Sydney, John Hopcropt Center for Computer Science,
    Shanghai Jiao Tong University.'
  ko: 'Affordance Field Intervention: Enabling VLAs to Escape Memory Traps in Robotic
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: AFI. Institution: The University
    of Sydney, John Hopcropt Center for Computer Science, Shanghai Jiao Tong University.
    arXiv: 2512.07472.'
sources:
- id: src_001
  type: paper
  title: 'Affordance Field Intervention: Enabling VLAs to Escape Memory Traps in Robotic
    Manipulation (arXiv)'
