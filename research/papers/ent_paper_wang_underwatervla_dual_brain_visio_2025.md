...
summary:
  ...
  zh: 'UnderwaterVLA: Dual-brain Vision-Language-Action architecture for Autonomous
    Underwater Navigation (UnderwaterVLA), is a 2025 large vision-language-action
    model for robotic manipulation, introduced by Westlake University, Zhejiang University,
    Australian National University.'
  ko: 'UnderwaterVLA: Dual-brain Vision-Language-Action architecture for Autonomous
...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: UnderwaterVLA. Institution:
    Westlake University, Zhejiang University, Australian National University. arXiv:
    2509.22441.'
sources:
- id: src_001
  type: paper
  title: 'UnderwaterVLA: Dual-brain Vision-Language-Action architecture for Autonomous
    Underwater Navigation (arXiv)'
