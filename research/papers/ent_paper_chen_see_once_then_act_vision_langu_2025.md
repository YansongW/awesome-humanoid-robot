...
verification:
  ...
  confidence: medium
  notes: 'Imported from Awesome-VLA curated list. Model: ViVLA. Institution: Beijing
    Institute of Technology, LimX Dynamics. arXiv: 2512.07582.'
sources:
- id: src_001
  type: paper
  title: 'See Once, Then Act: Vision-Language-Action Model with Task Learning from
    One-Shot Video Demonstrations (arXiv)'
