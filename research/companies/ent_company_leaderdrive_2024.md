...
summary:
  ...
  zh: 国产谐波减速器龙头，在国内机器人供应链中市占率不断提升。
...
verification:
  ...
  confidence: medium
  notes: Body backfilled from appendix-d/companies/company_leaderdrive.md by scripts/backfill_nonpaper_entries.py.
sources:
- id: src_001
  type: website
  title: Leaderdrive
...
## 参考
- [Leaderdrive](http://www.leaderdrive.com/)
- 项目 Wiki：appendix-d/companies/company_leaderdrive.md
