...
## 概述
特斯拉是人形机器人领域的重要整机厂商。以下内容整理自项目 Wiki，供深入查阅。
...
## 개요
테슬라는 휴머노이드 로봇 분야의 주요 완성체 제조사입니다. 아래 내용은 프로젝트 Wiki에서 정리한 것으로, 심층적인 참고를 위해 제공됩니다.

## 핵심 내용
## 테슬라 / Tesla, Inc.

> 이 항목은 [부록 D 기업/제품 Wiki](../../appendix-d.md)에 속합니다.
> 데이터 업데이트일: 2026-07-01. 모든 매개변수는 공식 공개 자료를 기준으로 하며, 누락된 항목은 "미공개"로 표시합니다.
...
| **본사** | 미국 텍사스주 오스틴 |
| **설립일** | 2003 |
| **공식 웹사이트** | [https://www.tesla.com](https://www.tesla.com) |
| **공급망 단계** | 완성체/OEM, 휴머노이드 로봇 완성체 제조사, 핵심 부품 자체 개발 |
| **기업 속성** | 상장 기업 (NASDAQ: TSLA) |
| **모회사/소속 그룹** | 없음 (Tesla, Inc.가 상장 주체) |
| **데이터 출처** | Tesla 공식 웹사이트, AI Day 공개 시연, 제3자 기술 종합 |

### 회사 소개

테슬라는 세계적으로 유명한 전기 자동차 및 청정 에너지 기업으로, Optimus 휴머노이드 로봇을 통해 수직 통합된 제조 및 AI 역량을 범용 로봇 분야로 확장하고 있습니다.

2021년 Tesla AI Day에서 Tesla Bot(이후 Optimus로 명명)을 처음 공개했으며, 목표는 먼저 테슬라 공장에 배치한 후 점차 기업 및 소비자 시장으로 확대하는 것입니다. Optimus는 테슬라 자체 개발 액추에이터, 배터리 팩, FSD 시각 인식 및 차량 탑재급 컴퓨팅 플랫폼을 기반으로 하며, 대규모 제조와 비용 통제를 강조합니다.

### 제품 라인

| 제품 라인 | 포지셔닝 | 대표 제품 | 응용 분야 |
|--------|------|----------|----------|
| Optimus 휴머노이드 로봇 | 범용/산업용 휴머노이드 | Optimus Gen 2 / Gen 1 | 공장 운반, 분류, 미래 가사 서비스 |
| 자율 주행 및 로봇 AI | 인식/계획 소프트웨어 스택 | FSD / Dojo | 차량 자율 주행, 로봇 작업 계획 |

### 대표 제품

### 공급망 위치

- **상류 핵심 부품/소재**: 자체 개발 액추에이터, 배터리 셀 및 전원 관리, 시각 센서, 컴퓨팅 칩; 일부 구조 부품 및 원자재는 외주.
- **하류 고객/응용 시나리오**: 테슬라 자체 공장, 미래 잠재적 자동차/물류 기업 및 소비자 시장.
- **주요 경쟁사/대상**: Figure AI, Boston Dynamics, Apptronik, 1X Technologies, Agility Robotics.

### 지식 그래프 노드 및 관계

- 회사 엔터티: `ent_company_tesla`
- 제품/플랫폼 엔터티: `ent_product_tesla_optimus_gen2`, `ent_product_tesla_optimus_gen1`
- 주요 관계:
  - `rel_ent_company_tesla_manufactures_ent_product_tesla_optimus_gen2` (`ent_company_tesla` → `manufactures` → `ent_product_tesla_optimus_gen2`)
  - `rel_ent_company_tesla_manufactures_ent_product_tesla_optimus_gen1` (`ent_company_tesla` → `manufactures` → `ent_product_tesla_optimus_gen1`)
...
1. [Tesla 공식 웹사이트](https://www.tesla.com)
2. [Tesla AI Day 2022 공개 시연](https://www.tesla.com/AI)
3. [Robohuman Tesla Optimus 사양 요약](https://robohuman.org/product/tesla-optimus)
