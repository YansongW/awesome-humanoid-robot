...
type: company
names:
  en: DEEPX and Sixfab Launch 'DEEPX AI HAT' to Drive Edge Physical AI on Raspberry
    Pi
...
summary:
  ...
  zh: -Partnership delivers high-performance, low-power AI acceleration directly to
    the global Raspberry Pi ecosystem -Eliminates cloud dependency for real-time inference
    in robotics and smart automation -Rolls out production-ready Starter Kit and SDKs
    to lower entry barriers for global developers
  ko: ''
...
- id: src_001
  type: website
  title: DEEPX and Sixfab Launch 'DEEPX AI HAT' to Drive Edge Physical AI on Raspberry
    Pi
