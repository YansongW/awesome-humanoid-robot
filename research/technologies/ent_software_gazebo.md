...
summary:
  ...
  zh: '核心内容 ### Gazebo的定义与定位 Gazebo属于 **software_platform** 类型。 所属领域包括：08_software_middleware。 价值链层级：intelligence。 提供物理引擎、传感器模型与场景编辑功能的开源三维机器人仿真器，用于算法开发与测试。
    英文名称为 *Gazebo*。 韩文名称为 *Gazebo*。'
...
## 核心内容
### Gazebo的定义与定位
Gazebo属于 **software_platform** 类型。 所属领域包括：08_software_middleware。 价值链层级：intelligence。 提供物理引擎、传感器模型与场景编辑功能的开源三维机器人仿真器，用于算法开发与测试。 英文名称为 *Gazebo*。 韩文名称为 *Gazebo*。
...
### 在人形机器人系统中的作用
作为人形机器人产业链中的关键software_platform之一，Gazebo在系统设计、性能优化和产业化应用中扮演着重要角色。它与感知、决策、执行、能源、结构与验证等多个子系统相互耦合，共同决定了整机性能。相关研究与应用正在持续推进，以进一步提升其在实际场景中的可靠性、效率和经济性。
