...
summary:
  ...
  zh: '核心内容 ### MoveIt 运动规划的定义与定位 MoveIt 运动规划属于 **software_platform** 类型。 所属领域包括：08_software_middleware, 07_ai_models_algorithms。
    价值链层级：intelligence。 常用于机械臂和全身运动规划的框架。 英文名称为 *MoveIt Motion Planning*。 韩文名称为 *MoveIt 모션 계획*。'
...
## 核心内容
### MoveIt 运动规划的定义与定位
MoveIt 运动规划属于 **software_platform** 类型。 所属领域包括：08_software_middleware, 07_ai_models_algorithms。 价值链层级：intelligence。 常用于机械臂和全身运动规划的框架。 英文名称为 *MoveIt Motion Planning*。 韩文名称为 *MoveIt 모션 계획*。
...
### 在人形机器人系统中的作用
作为人形机器人产业链中的关键software_platform之一，MoveIt 运动规划在系统设计、性能优化和产业化应用中扮演着重要角色。它与感知、决策、执行、能源、结构与验证等多个子系统相互耦合，共同决定了整机性能。相关研究与应用正在持续推进，以进一步提升其在实际场景中的可靠性、效率和经济性。
