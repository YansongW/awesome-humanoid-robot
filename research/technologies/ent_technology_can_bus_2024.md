...
summary:
  ...
  zh: '核心内容 ### CAN 总线的定义与定位 CAN 总线属于 **technology** 类型。 所属领域包括：08_software_middleware, 06_design_engineering。 价值链层级：intelligence,
    midstream。 连接人形机器人关节电机驱动与中央控制器的现场总线。 英文名称为 *CAN Bus*。 韩文名称为 *CAN Bus*。'
