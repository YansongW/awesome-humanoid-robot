...
type: report
names:
  en: NVIDIA Research Unlocks Advanced Grasping, Smarter Autonomous Driving and Agent
    Training at Scale
...
summary:
  ...
  zh: What makes a robot gripper useful isn’t that it can pick up one object — it’s
    that it can pick up the next one, and the one after that, with a tool it’s never
    held before. What makes an autonomous vehicle system safe isn’t just that it can
    reason through a situation — it’s that [&#8230;]
...
- id: src_001
  type: website
  title: NVIDIA Research Unlocks Advanced Grasping, Smarter Autonomous Driving and
