...
summary:
  ...
  zh: '核心内容 ### Thevenin 等效电路的定义与定位 Thevenin 等效电路属于 **formalism** 类型。 所属领域包括：00_foundations, 06_design_engineering。 价值链层级：foundations,
    midstream。 一种形式化方法，将任意线性电网络从两个端子看进去替换为一个等效理想电压源串联一个等效电阻。 英文名称为 *Thevenin Equivalent Circuit*。 韩文名称为 *테베닌 등가 회로*。'
