...
summary:
  ...
  zh: '核心内容 ### 扩散策略的定义与定位 扩散策略属于 **method** 类型。 所属领域包括：07_ai_models_algorithms, 09_data_datasets。 价值链层级：intelligence。 将动作分布建模为去噪扩散模型的视觉运动策略，可生成多峰且平滑的机器人动作。
    英文名称为 *Diffusion Policy*。 韩文名称为 *디퓨전 정책*。'
...
## 核心内容
### 扩散策略的定义与定位
扩散策略属于 **method** 类型。 所属领域包括：07_ai_models_algorithms, 09_data_datasets。 价值链层级：intelligence。 将动作分布建模为去噪扩散模型的视觉运动策略，可生成多峰且平滑的机器人动作。 英文名称为 *Diffusion Policy*。 韩文名称为 *디퓨전 정책*。
