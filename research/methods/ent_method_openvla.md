...
summary:
  ...
  zh: '核心内容 ### OpenVLA的定义与定位 OpenVLA属于 **method** 类型。 所属领域包括：07_ai_models_algorithms, 09_data_datasets。 价值链层级：intelligence。
    基于Open X-Embodiment数据集训练的开源视觉-语言-动作模型，用于可泛化的机器人操作。 英文名称为 *OpenVLA*。 韩文名称为 *OpenVLA*。'
...
## 核心内容
### OpenVLA的定义与定位
OpenVLA属于 **method** 类型。 所属领域包括：07_ai_models_algorithms, 09_data_datasets。 价值链层级：intelligence。 基于Open X-Embodiment数据集训练的开源视觉-语言-动作模型，用于可泛化的机器人操作。 英文名称为 *OpenVLA*。 韩文名称为 *OpenVLA*。
