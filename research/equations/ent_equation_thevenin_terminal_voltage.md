...
summary:
  ...
  zh: '核心内容 ### Thevenin 端电压方程的定义与定位 Thevenin 端电压方程属于 **equation** 类型。 所属领域包括：00_foundations, 06_design_engineering。 价值链层级：foundations,
    midstream。 给出 Thevenin 等效电路端电压等于开路电压减去等效电阻上压降的方程。 英文名称为 *Thevenin Terminal Voltage Equation*。 韩文名称为 *테베닌 단자 전압 방정식*。'
