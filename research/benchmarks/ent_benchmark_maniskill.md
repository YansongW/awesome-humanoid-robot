...
summary:
  ...
  zh: '核心内容 ### ManiSkill的定义与定位 ManiSkill属于 **benchmark** 类型。 所属领域包括：10_evaluation_benchmarks。 价值链层级：validation_markets。 面向可泛化操作技能的统一基准，提供标准化任务、仿真环境与评估协议。
    英文名称为 *ManiSkill*。 韩文名称为 *ManiSkill*。'
