---
$id: rel_ent_human_level_actuation_score_discusses_ent_human_equivalence_envelope
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 人类级驱动能力评分基准评估了人类等效包络技术。 | 证据: - **Human-Equivalence
    Envelope coverage**: Ability to meet human torque and power simultaneously at task-relevant postures and rates. | WP2.3
    2026-08-06: type retyped evaluates_on->discusses after DeepSeek review. Reason: 同篇技术报告的姊妹指标，evaluates_on 错配，discusses
    成立. Original file rel_ent_human_level_actuation_score_evaluates_on_ent_human_equivalence_envelope.'
sources:
- id: src_001
  type: other
