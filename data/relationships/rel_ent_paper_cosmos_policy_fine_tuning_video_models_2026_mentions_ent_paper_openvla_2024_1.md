---
$id: rel_ent_paper_cosmos_policy_fine_tuning_video_models_2026_mentions_ent_paper_openvla_2024_1
...
description:
  en: 'Cosmos Policy: Fine-Tuning Video Models for Visuomotor Control and Planning mentions OpenVLA.'
  zh: 'Cosmos Policy: Fine-Tuning Video Models for Visuomotor Control and Planning提及OpenVLA。'
verification:
  status: unverified
  reviewed_by: ai
  reviewed_at: '2026-08-06'
  confidence: low
  notes: 'Mined by build_latent_relationships.py rule p5b_acronym. Evidence: | OpenVLA-OFT | - | - | - | - | 97.'
sources:
- id: src_001
  type: other
