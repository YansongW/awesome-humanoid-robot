---
$id: rel_ent_software_drake_systems_toolbox_2024_uses_ent_method_model_predictive_control
...
description:
  en: Drake provides optimization-based control tools for MPC development.
...
verification:
  ...
  notes: 'bulk-added confidence on 2026-07-17 by backfill_rel_confidence.py; pending human review | WP4 2026-08-11: endpoint
    id rewritten (ent_software_drake_systems_toolbox_2024→ent_software_drake_systems_toolbox_2024, ent_method_model_predictive_control→ent_method_model_predictive_control);
    original file rel_ent_software_drake_systems_toolbox_2024_used_by_ent_paper_model_predictive_control_2024.'
