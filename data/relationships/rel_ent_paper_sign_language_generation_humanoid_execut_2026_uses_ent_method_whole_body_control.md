---
$id: rel_ent_paper_sign_language_generation_humanoid_execut_2026_uses_ent_method_whole_body_control
...
description:
  ...
  zh: 'From Sign Language Generation to Humanoid Execution: Vision-Language Guided Retargeting with Collision Mitigation使用全身控制（WBC）。'
verification:
  status: partially_verified
  reviewed_by: ai
  reviewed_at: '2026-08-06'
  confidence: medium
  notes: 'Mined by build_latent_relationships.py rule p6_llm_link. Evidence: 手语生成的人形执行需要全身控制来避免自交。'
sources:
- id: src_001
  type: other
