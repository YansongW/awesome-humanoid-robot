---
$id: rel_ent_paper_lakhnati_exploring_a_gpt_based_large_la_2024_cites_ent_paper_kaidanov_the_role_of_domain_randomizati_2024
...
description:
  en: Exploring a GPT-based Large Language Model for Variable Autonomy in a VR-based
    Human-Robot Teaming Simulation cites or references The Role of Domain Randomization
    in Training Diffusion Policies for Whole-Body Humanoid Control.
  zh: ''
  ko: ''
verification:
