---
$id: rel_ent_method_diffusion_policy_implemented_on_ent_robot_unitree_h1_humanoid_robot_2024
...
domains:
  ...
  - 02_components
description:
  en: Diffusion Policy can be deployed on Unitree H1 for manipulation tasks.
...
verification:
  ...
  notes: 'bulk-added confidence on 2026-07-17 by backfill_rel_confidence.py; pending human review | WP4 2026-08-11: endpoint
    id rewritten (ent_method_diffusion_policy→ent_method_diffusion_policy, ent_robot_unitree_h1_humanoid_robot_2024→ent_robot_unitree_h1_humanoid_robot_2024);
    original file rel_ent_paper_diffusion_policy_2023_implemented_on_ent_robot_unitree_h1_humanoid_robot_2024.'
