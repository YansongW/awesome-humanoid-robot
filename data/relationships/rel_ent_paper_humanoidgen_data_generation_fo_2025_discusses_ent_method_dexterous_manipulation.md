---
$id: rel_ent_paper_humanoidgen_data_generation_fo_2025_discusses_ent_method_dexterous_manipulation
...
description:
  en: 'HumanoidGen: Data Generation for Bimanual Dexterous Manipulation via LLM Reasoning discusses Dexterous Manipulation.'
  zh: 'HumanoidGen: Data Generation for Bimanual Dexterous Manipulation via LLM Reasoningdiscusses灵巧操作。'
verification:
  status: partially_verified
  reviewed_by: ai
  reviewed_at: '2026-07-16'
  confidence: medium
  notes: 'Mined by build_latent_relationships.py rule p6_llm_link. Evidence: 该论文专注于双臂灵巧操作的数据生成。'
sources:
- id: src_001
  type: other
