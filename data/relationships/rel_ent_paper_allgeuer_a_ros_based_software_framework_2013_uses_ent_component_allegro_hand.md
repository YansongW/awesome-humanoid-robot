---
$id: rel_ent_paper_allgeuer_a_ros_based_software_framework_2013_uses_ent_component_allegro_hand
...
description:
  en: A ROS-based Software Framework for the NimbRo-OP Humanoid Open Platform uses
    or builds on Allegro Hand.
  zh: ''
  ko: ''
verification:
