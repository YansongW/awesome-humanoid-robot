---
$id: rel_ent_paper_nelson_open_h_embodiment_a_large_scal_2026_cites_ent_dataset_open_x_embodiment
...
description:
  en: The paper cites Open-X-Embodiment as related large-scale cross-embodiment robotic
    learning infrastructure.
  zh: 本文引用Open-X-Embodiment作为相关的大规模跨具身机器人学习基础设施。
  ko: 본 논문은 관련 대규모 다중 구현 로봇 학습 인프라로 Open-X-Embodiment를 인용한다.
verification:
  status: partially_verified
  reviewed_by: ai
  reviewed_at: '2026-06-27'
  confidence: medium
  notes: 'Proposed by AI extraction. Source citation: Metadata: ''datasets_used'':
    [..., ''Open-X-Embodiment''].'
sources:
- id: src_001
  type: paper
