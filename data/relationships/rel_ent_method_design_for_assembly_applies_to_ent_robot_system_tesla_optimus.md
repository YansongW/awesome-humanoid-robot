---
$id: rel_ent_method_design_for_assembly_applies_to_ent_robot_system_tesla_optimus
...
description:
  en: DFA is applied to Tesla Optimus to reduce assembly cycle time.
...
verification:
  ...
  notes: 'bulk-added confidence on 2026-07-17 by backfill_rel_confidence.py; pending human review | WP4 2026-08-11: endpoint
    id rewritten (ent_method_design_for_assembly→ent_method_design_for_assembly, ent_robot_system_tesla_optimus→ent_robot_system_tesla_optimus);
    original file rel_ent_paper_design_for_assembly_2024_applies_to_ent_robot_system_tesla_optimus.'
