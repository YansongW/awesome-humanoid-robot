---
$id: rel_ent_process_p1_mentions_ent_process_p16_1_1
...
description:
  en: Requirements Definition and System Design (Concept / Pre-A) mentions DFM/DFA review.
  zh: 需求定义与系统方案（Concept / Pre-A）提及DFM/DFA 评审。
verification:
  status: unverified
  reviewed_by: ai
