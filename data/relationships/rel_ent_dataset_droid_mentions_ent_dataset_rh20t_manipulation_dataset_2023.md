---
$id: rel_ent_dataset_droid_mentions_ent_dataset_rh20t_manipulation_dataset_2023
...
description:
  en: DROID mentions RH20T Manipulation Dataset.
  zh: DROID 机器人操作数据集提及RH20T 操作数据集。
verification:
  status: unverified
  reviewed_by: ai
