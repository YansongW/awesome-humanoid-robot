---
$id: rel_ent_paper_cen_worldvla_towards_autoregressiv_2025_proposes_ent_concept_world_model
...
description:
  en: 'WorldVLA: Towards Autoregressive Action World Model proposes World Model.'
  zh: WorldVLA提出世界模型。
verification:
  ...
  confidence: medium
  notes: 'Mined by build_latent_relationships.py rule p6_llm_link. Evidence: 提出了自回归动作世界模型WorldVLA'
sources:
- id: src_001
  type: other
