---
$id: rel_ent_paper_dreamtrajectory_trajectory_guided_action_2026_mentions_ent_paper_liu_rdt_1b_a_diffusion_foundation_2024
...
description:
  en: 'DreamTrajectory: Trajectory-Guided Action Generation with World Model Alignment for Mobile Manipulation mentions RDT-1B:
    a Diffusion Foundation Model for Bimanual Manipulation.'
  zh: 'DreamTrajectory: Trajectory-Guided Action Generation with World Model Alignment for Mobile Manipulation提及RDT-1B。'
verification:
  status: unverified
  reviewed_by: ai
  reviewed_at: '2026-08-06'
  confidence: low
  notes: 'Mined by build_latent_relationships.py rule p5b_acronym. Evidence: 基线包括 ACT、Diffusion Policy、RDT-1B、GR00T N1 与 π₀.'
sources:
- id: src_001
  type: other
