---
$id: rel_ent_method_openvla_uses_dataset_ent_dataset_open_x_embodiment
...
verification:
  confidence: medium
  notes: 'bulk-added confidence on 2026-07-17 by backfill_rel_confidence.py; pending human review | WP3 2026-08-06: endpoint
    rewritten (ent_method_openvla→ent_method_openvla, ent_dataset_open_x_embodiment→ent_dataset_open_x_embodiment) after
    merge. Original file rel_ent_paper_openvla_2024_1_uses_dataset_ent_dataset_open_x_embodiment.'
