---
$id: rel_ent_process_p16_3_1_mentions_ent_process_p5
...
description:
  en: Pilot Run mentions Ontological Structure Engineering and Prototyping (Mechanical Structure).
  zh: 小批量试产（Pilot Run）提及本体结构工程与原型（Mechanical Structure）。
verification:
  status: unverified
  reviewed_by: ai
