---
$id: rel_ent_process_p1_mentions_ent_process_p16_1_3
...
description:
  en: Requirements Definition and System Design (Concept / Pre-A) mentions Assembly line planning and SOP.
  zh: 需求定义与系统方案（Concept / Pre-A）提及装配线规划与 SOP。
verification:
  status: unverified
  reviewed_by: ai
