---
$id: rel_ent_paper_four_simple_proprioceptive_est_2026_uses_ent_method_zero_moment_point
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 论文使用零力矩点（ZMP）方法推导地面反作用力。 | 证据: These estimators
    ...
    Kalman Filter (EKF) to estimate body posture, and deriving ground reaction forces and the Zero Moment Point (ZMP) | WP4
    2026-08-11: endpoint id rewritten (ent_paper_four_simple_proprioceptive_est_2026→ent_paper_four_simple_proprioceptive_est_2026,
    ent_method_zero_moment_point→ent_method_zero_moment_point); original file rel_ent_paper_four_simple_proprioceptive_est_2026_uses_ent_paper_zero_moment_point_2024.'
sources:
- id: src_001
  type: other
