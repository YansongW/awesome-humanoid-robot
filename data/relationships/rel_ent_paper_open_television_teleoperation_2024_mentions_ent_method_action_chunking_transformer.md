---
$id: rel_ent_paper_open_television_teleoperation_2024_mentions_ent_method_action_chunking_transformer
...
verification:
  ...
  confidence: low
  notes: 'Mined by build_latent_relationships.py rule p5b_acronym. Evidence: 在动作生成端，系统采用行为克隆（ACT）作为基础模仿学习范式，并引入扩散策略或流匹配技术，将动作生成建模为条件生成问题。'
sources:
- id: src_001
  type: other
