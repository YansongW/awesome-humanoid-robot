---
$id: rel_ent_paper_imitation_bc_dagger_diffusion_compares_with_ent_method_diffusion_policy
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 论文将自身方法与Diffusion Policy进行对比。 | 证据: - 相比 Diffusion
    Policy：论文未提及扩散模型，方法属于迭代优化框架，而非生成式建模。 | WP4 2026-08-11: endpoint id rewritten (ent_paper_imitation_bc_dagger_diffusion→ent_paper_imitation_bc_dagger_diffusion,
    ent_method_diffusion_policy→ent_method_diffusion_policy); original file rel_ent_paper_imitation_bc_dagger_diffusion_compares_with_ent_paper_diffusion_policy_2023.'
sources:
- id: src_001
  type: other
