...
description:
  en: Harmonic-drive reducers are used in the arm joints and exhibit asymmetric acceleration/braking behaviour.
...
verification:
  ...
  confidence: medium
  notes: 'Proposed by AI extraction. Source citation: Limitations: Single efficiency parameter is used for both acceleration
    and braking despite asymmetric harmonic-drive behaviour.'
sources:
- id: src_001
  type: paper
