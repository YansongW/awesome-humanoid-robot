---
$id: rel_ent_paper_deniz_identification_of_a_physics_ba_2026_integrates_ent_component_battery_management_system
...
description:
  en: The Battery Management System is part of the onboard power measurement chain.
  zh: 电池管理系统是车载功率测量链的一部分。
  ko: 배터리 관리 시스템은 온보드 전력 측정 체인의 일부입니다.
verification:
