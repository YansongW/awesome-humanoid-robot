---
$id: rel_ent_process_p14_1_2_is_part_of_ent_process_p14
...
description:
  en: Real-time control framework is part of Software & Integration.
  zh: 实时控制框架is_part_of软件中间件与系统集成（Software & Integration）。
verification:
  status: partially_verified
  reviewed_by: ai
  reviewed_at: '2026-07-16'
  confidence: medium
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 证据表明实时控制框架属于Software & Integration阶段/工作包 | 证据:
