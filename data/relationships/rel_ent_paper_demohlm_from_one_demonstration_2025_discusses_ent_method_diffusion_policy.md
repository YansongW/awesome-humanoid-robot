---
$id: rel_ent_paper_demohlm_from_one_demonstration_2025_discusses_ent_method_diffusion_policy
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 证据表明源论文评估了Diffusion Policy架构，因此Diffusion Policy是被评估的对象。
    ...
    after DeepSeek review. Reason: 目标是方法非基准（DeepSeek 原始输出被截断，人工按同组规律补齐）. Original file rel_ent_paper_demohlm_from_one_demonstration_2025_evaluates_on_ent_method_diffusion_policy.'
sources:
- id: src_001
  type: other
