---
$id: rel_ent_paper_pi0_2024_mentions_ent_paper_brohan_rt_2_vision_language_action_mo_2023
...
description:
  en: 'π0: A Vision-Language-Action Flow Model for General Robot Control mentions RT-2: Vision-Language-Action Models Transfer
    Web Knowledge to Robotic Control.'
  zh: π0：用于通用机器人控制的视觉-语言-动作流模型提及RT-2。
verification:
  status: unverified
  reviewed_by: ai
  reviewed_at: '2026-08-06'
  confidence: low
  notes: 'Mined by build_latent_relationships.py rule p5b_acronym. Evidence: 机器人学习长期受困于数据稀缺、泛化差和鲁棒性不足，此前的主流方案要么是任务特定的行为克隆（如
