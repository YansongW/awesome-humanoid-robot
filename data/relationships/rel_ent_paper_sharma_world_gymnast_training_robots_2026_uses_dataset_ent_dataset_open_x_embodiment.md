...
description:
  en: Both OpenVLA and the WorldGym variant are pretrained on the Open X-Embodiment dataset.
...
verification:
  ...
  confidence: medium
  notes: 'Proposed by AI extraction. Source citation: OpenVLA ... was originally trained on Open X-Embodiment dataset (Vuong
    et al., 2023). For WorldGym, we used a 600M parameter variant pretrained on Open X-Embodiment dataset.'
sources:
- id: src_001
  type: paper
