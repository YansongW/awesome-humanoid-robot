---
$id: rel_ent_paper_baek_toward_control_of_wheeled_huma_2024_is_based_on_ent_active_set_method
...
description:
  en: 'Toward Control of Wheeled Humanoid Robots with Unknown Payloads: Equilibrium
    Point Estimation via Real-to-Sim Adaptation is based on or uses Active-set method.'
  zh: ''
  ko: ''
verification:
