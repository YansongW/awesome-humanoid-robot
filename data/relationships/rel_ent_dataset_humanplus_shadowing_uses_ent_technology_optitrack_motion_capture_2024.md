...
verification:
  ...
  confidence: low
  notes: 'Mined by build_latent_relationships.py rule p6_llm_link. Evidence: 影子数据收集过程可能使用了OptiTrack运动捕捉技术。 [downgraded to low on 2026-07-17: hedged LLM evidence]'
sources:
- id: src_001
  type: other
