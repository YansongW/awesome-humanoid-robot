---
$id: rel_ent_paper_liu_humanoid_whole_body_badminton_2026_cites_ent_paper_allman_multi_agent_reinforcement_lear_2025
...
description:
  en: 'Humanoid Whole-Body Badminton via Multi-Stage Reinforcement Learning cites
    or references Multi-Agent Reinforcement Learning for Cooperative Warehouse Automation:
    QMIX Value Decomposition for Sparse-Reward Coordination.'
  zh: ''
  ko: ''
verification:
