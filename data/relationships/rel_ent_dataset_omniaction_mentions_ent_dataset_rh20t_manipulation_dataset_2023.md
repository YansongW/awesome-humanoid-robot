---
$id: rel_ent_dataset_omniaction_mentions_ent_dataset_rh20t_manipulation_dataset_2023
...
description:
  en: OmniAction Dataset mentions RH20T Manipulation Dataset.
  zh: OmniAction 数据集提及RH20T 操作数据集。
verification:
  status: unverified
  reviewed_by: ai
