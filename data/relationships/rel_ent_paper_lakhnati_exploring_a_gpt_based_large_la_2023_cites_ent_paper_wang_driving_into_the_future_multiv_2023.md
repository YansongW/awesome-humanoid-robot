---
$id: rel_ent_paper_lakhnati_exploring_a_gpt_based_large_la_2023_cites_ent_paper_wang_driving_into_the_future_multiv_2023
...
description:
  en: 'Exploring a GPT-based Large Language Model for Variable Autonomy in a VR-based
    Human-Robot Teaming Simulation cites or references Drive-WM: Driving into the
    Future: Multiview Visual Forecasting and Planning with World Model for Autonomous
    Driving.'
  zh: ''
  ko: ''
verification:
