---
$id: rel_ent_paper_demohlm_from_one_demonstration_2025_evaluates_on_ent_paper_diffusion_policy_2023
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 证据表明源论文评估了Diffusion Policy架构，因此Diffusion Policy是被评估的对象。
    | 证据: 评估三种架构：MLP（动作分块）、ACT（CVAE 式 transformer）、Diffusion Policy。'
sources:
- id: src_001
  type: other
