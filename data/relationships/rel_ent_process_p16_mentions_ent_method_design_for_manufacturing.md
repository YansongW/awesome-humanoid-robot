---
$id: rel_ent_process_p16_mentions_ent_method_design_for_manufacturing
...
description:
  en: Pilot & Production Ramp mentions Design for Manufacturing (DFM).
  zh: 小批量试产与量产准备（Pilot & Production Ramp）提及可制造性设计（DFM）。
verification:
  status: unverified
  reviewed_by: ai
