---
$id: rel_ent_paper_cosmos_policy_fine_tuning_video_models_2026_compares_with_ent_method_diffusion_policy
...
verification:
  ...
  confidence: medium
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: Cosmos Policy 与 Diffusion Policy 进行了比较，指出其从零训练的缺点。
