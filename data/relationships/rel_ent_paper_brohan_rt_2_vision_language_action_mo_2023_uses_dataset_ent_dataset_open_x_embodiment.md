---
$id: rel_ent_paper_brohan_rt_2_vision_language_action_mo_2023_uses_dataset_ent_dataset_open_x_embodiment
...
description:
  en: Open X-Embodiment data is used to train RT-2 and RT-X.
...
verification:
  ...
  notes: 'bulk-added confidence on 2026-07-17 by backfill_rel_confidence.py; pending human review | WP4 2026-08-11: endpoint
    id rewritten (ent_paper_brohan_rt_2_vision_language_action_mo_2023→ent_paper_brohan_rt_2_vision_language_action_mo_2023, ent_dataset_open_x_embodiment→ent_dataset_open_x_embodiment);
    original file rel_ent_paper_rt_2_vision_language_action_mo_2023_uses_dataset_ent_dataset_open_x_embodiment.'
