---
$id: rel_ent_method_design_for_assembly_mentions_ent_method_value_analysis_value_engineering
...
description:
  en: Design for Assembly (DFA) mentions Value Analysis / Value Engineering (VA/VE).
  zh: 可装配性设计（DFA）提及价值分析/价值工程（VA/VE）。
verification:
  status: unverified
  reviewed_by: ai
