---
$id: rel_ent_process_p10_3_1_is_part_of_ent_process_p10
...
description:
  en: System Identification and Parameter Calibration is part of Motion Control Algorithm Development and Validation.
  zh: 系统辨识与参数校准is_part_of运动控制算法开发与验证（Motion Control）。
verification:
