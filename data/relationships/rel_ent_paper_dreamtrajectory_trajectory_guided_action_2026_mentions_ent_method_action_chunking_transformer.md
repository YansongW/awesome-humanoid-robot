---
$id: rel_ent_paper_dreamtrajectory_trajectory_guided_action_2026_mentions_ent_method_action_chunking_transformer
...
description:
  en: 'DreamTrajectory: Trajectory-Guided Action Generation with World Model Alignment for Mobile Manipulation mentions Action
    Chunking with Transformers (ACT).'
  zh: 'DreamTrajectory: Trajectory-Guided Action Generation with World Model Alignment for Mobile Manipulation提及动作分块变压器（ACT）。'
verification:
  status: unverified
  reviewed_by: ai
