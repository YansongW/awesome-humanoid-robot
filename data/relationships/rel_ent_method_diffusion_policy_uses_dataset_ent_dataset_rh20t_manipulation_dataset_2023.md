---
$id: rel_ent_method_diffusion_policy_uses_dataset_ent_dataset_rh20t_manipulation_dataset_2023
...
domains:
  ...
  - 07_ai_models_algorithms
description:
  en: Diffusion Policy can be trained on RH20T contact-rich manipulation data.
...
verification:
  ...
  notes: 'bulk-added confidence on 2026-07-17 by backfill_rel_confidence.py; pending human review | WP4 2026-08-11: endpoint
    id rewritten (ent_method_diffusion_policy→ent_method_diffusion_policy, ent_dataset_rh20t_manipulation_dataset_2023→ent_dataset_rh20t_manipulation_dataset_2023);
    original file rel_ent_paper_diffusion_policy_2023_uses_dataset_ent_dataset_rh20t_manipulation_dataset_2023.'
