---
$id: rel_ent_paper_grinberg_contact_sensing_via_joint_torq_2025_cites_ent_paper_benzi_energy_tank_based_control_fram_2023
...
description:
  en: Contact Sensing via Joint Torque Sensors and a Force/Torque Sensor for Legged
    Robots cites or references Energy Tank-based Control Framework for Satisfying
    the ISO/TS 15066 Constraint.
  zh: ''
  ko: ''
verification:
