...
description:
  en: Validates the hierarchical MPC framework through simulation and hardware experiments
...
verification:
  ...
  confidence: medium
  notes: 'Proposed by AI extraction. Source citation: Abstract: ''We validate the
    performance of our approach through simulation and hardware experiments on the
