---
$id: rel_ent_paper_patch_policy_efficient_embodied_control_2026_uses_ent_method_diffusion_policy
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 论文评估了Diffusion Policy作为动作头之一。 | 证据: - 动作头在每帧最后一个
    ...
    evaluates_on->uses after DeepSeek review. Reason: 证据句表明论文将扩散策略作为动作头之一，属于使用关系，而非在基准数据集上评估。. Original file rel_ent_paper_patch_policy_efficient_embodied_control_2026_evaluates_on_ent_method_diffusion_policy.'
sources:
- id: src_001
  type: other
