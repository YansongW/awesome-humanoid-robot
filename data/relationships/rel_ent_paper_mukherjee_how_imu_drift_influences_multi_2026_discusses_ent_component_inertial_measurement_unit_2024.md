---
$id: rel_ent_paper_mukherjee_how_imu_drift_influences_multi_2026_discusses_ent_component_inertial_measurement_unit_2024
...
description:
  en: How IMU Drift Influences Multi-Radar Inertial Odometry for Ground Robots in Subterranean Terrains discusses Inertial
    Measurement Unit.
  zh: IMU漂移如何影响地下地形地面机器人的多雷达惯性里程计discusses惯性测量单元。
verification:
  status: partially_verified
  reviewed_by: ai
  reviewed_at: '2026-07-16'
  confidence: medium
  notes: 'Mined by build_latent_relationships.py rule p6_llm_link. Evidence: 论文讨论惯性测量单元漂移对多雷达惯性里程计的影响'
sources:
- id: src_001
  type: other
