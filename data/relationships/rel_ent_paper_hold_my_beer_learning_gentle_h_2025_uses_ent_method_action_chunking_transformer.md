---
$id: rel_ent_paper_hold_my_beer_learning_gentle_h_2025_uses_ent_method_action_chunking_transformer
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: Hold My Beer论文中明确提到采用ACT（Action Chunking with
    ...
    Cloning）方法，将人类示范的全身轨迹、末端执行器/腕手目标以及低层控制器目标建模为监督学习问题。 | WP4 2026-08-11: endpoint id rewritten (ent_paper_hold_my_beer_learning_gentle_h_2025→ent_paper_hold_my_beer_learning_gentle_h_2025,
    ent_method_action_chunking_transformer→ent_method_action_chunking_transformer); original file rel_ent_paper_hold_my_beer_learning_gentle_h_2025_uses_ent_paper_action_chunking_with_transform_2023.'
sources:
- id: src_001
  type: other
