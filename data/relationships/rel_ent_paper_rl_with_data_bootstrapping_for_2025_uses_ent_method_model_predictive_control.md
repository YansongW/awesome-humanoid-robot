---
$id: rel_ent_paper_rl_with_data_bootstrapping_for_2025_uses_ent_method_model_predictive_control
...
description:
  en: RL with Data Bootstrapping for Dynamic Subgoal Pursuit in Humanoid Robot Navigation uses Model Predictive Control (MPC).
  zh: RL with Data Bootstrapping for Dynamic Subgoal Pursuit in Humanoid Robot Navigation使用模型预测控制（MPC）。
verification:
