---
$id: rel_ent_process_p16_3_1_mentions_ent_process_p5_1_2
...
description:
  en: Pilot Run mentions Joint mounting interface and housing design.
  zh: 小批量试产（Pilot Run）提及关节安装接口与壳体设计。
verification:
  status: unverified
  reviewed_by: ai
