---
$id: rel_ent_paper__2025_uses_ent_method_action_chunking_transformer
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 论文中描述系统采用ACT（Action Chunking with Transformers）来生成可执行的动作命令。
    ...
    | WP4 2026-08-11: endpoint id rewritten (ent_paper__2025→ent_paper__2025, ent_method_action_chunking_transformer→ent_method_action_chunking_transformer);
    original file rel_ent_paper__2025_uses_ent_paper_action_chunking_with_transform_2023.'
sources:
- id: src_001
  type: other
