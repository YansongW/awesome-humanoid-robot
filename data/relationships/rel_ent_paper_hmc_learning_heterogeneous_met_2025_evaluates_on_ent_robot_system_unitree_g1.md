---
$id: rel_ent_paper_hmc_learning_heterogeneous_met_2025_evaluates_on_ent_robot_system_unitree_g1
...
verification:
  ...
  notes: 'Proposed by AI extraction. Source citation: Key contribution 4: ''Real-world validation on a Unitree G1 humanoid
    across contact-rich tasks such as wiping, bottle lifting, and drawer opening.'' | WP1 2026-08-06: endpoint rewritten (ent_paper_hmc_learning_heterogeneous_met_2025→ent_paper_hmc_learning_heterogeneous_met_2025,
    ent_robot_system_unitree_g1→ent_robot_system_unitree_g1) after duplicate merge; original file rel_ent_paper_wei_hmc_learning_heterogeneous_met_2025_evaluates_on_ent_robot_system_unitree_g1.'
sources:
- id: src_001
  type: paper
