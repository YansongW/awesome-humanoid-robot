---
$id: rel_ent_paper_lakhnati_exploring_a_gpt_based_large_la_2023_cites_ent_paper_allgeuer_a_ros_based_software_framework_2013
...
description:
  en: Exploring a GPT-based Large Language Model for Variable Autonomy in a VR-based
    Human-Robot Teaming Simulation cites or references A ROS-based Software Framework
    for the NimbRo-OP Humanoid Open Platform.
  zh: ''
  ko: ''
verification:
