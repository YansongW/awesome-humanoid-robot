---
$id: rel_ent_method_diffusion_policy_mentions_ent_paper_action_chunking_with_transform_2023
...
description:
  en: Diffusion Policy mentions Action Chunking with Transformers.
  zh: 扩散策略提及基于Transformer的动作分块。
verification:
  status: unverified
  reviewed_by: ai
