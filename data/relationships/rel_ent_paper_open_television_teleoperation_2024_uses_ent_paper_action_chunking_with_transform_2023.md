---
$id: rel_ent_paper_open_television_teleoperation_2024_uses_ent_paper_action_chunking_with_transform_2023
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: Open-TeleVision论文使用ACT（Action Chunking with
    ...
    rewritten (ent_paper_open_television_teleoperation_2024→ent_paper_open_television_teleoperation_2024, ent_paper_action_chunking_with_transform_2023→ent_paper_action_chunking_with_transform_2023)
