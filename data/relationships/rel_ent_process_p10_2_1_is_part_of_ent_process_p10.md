---
$id: rel_ent_process_p10_2_1_is_part_of_ent_process_p10
...
description:
  en: Standing and Anti-Interference Balance Control is part of Motion Control Algorithm Development and Validation.
  zh: 站立与抗扰平衡控制is_part_of运动控制算法开发与验证（Motion Control）。
verification:
