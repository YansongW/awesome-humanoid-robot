---
$id: rel_ent_paper_pulse_physically_plausible_uni_2026_discusses_ent_method_sim_to_real
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 论文PULSE在真实机器人平台上验证了Sim-to-Real迁移的有效性，因此在该场景下评估了该方法。
    | 证据: 此外，该框架在真实机器人平台上的初步部署验证了其Sim-to-Real迁移的有效性，为家庭服务、灾害救援等场景下的通用人形机器人技能库构建提供了关键技术支撑。 | WP2.3 2026-08-06: type retyped
    evaluates_on->discusses after DeepSeek review. Reason: 证据句表明论文在真实平台验证了Sim-to-Real迁移的有效性，但目标实体是方法而非基准/数据集，不符合evaluates_on类型，应改为discusses。.
    Original file rel_ent_paper_pulse_physically_plausible_uni_2026_evaluates_on_ent_method_sim_to_real.'
sources:
- id: src_001
  type: other
