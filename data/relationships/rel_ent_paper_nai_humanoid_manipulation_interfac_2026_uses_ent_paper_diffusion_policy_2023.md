---
$id: rel_ent_paper_nai_humanoid_manipulation_interfac_2026_uses_ent_paper_diffusion_policy_2023
...
verification:
  ...
  confidence: medium
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 证据表明该论文使用Diffusion Policy作为高层策略来学习预测关键点轨迹。 |
    证据: - **高层策略**：使用 Diffusion Policy 从人类演示中学习预测关键点轨迹（如手部、躯干、脚部位置），作为任务规划层。'
sources:
- id: src_001
  type: other
