---
$id: rel_ent_kkt_conditions_mentions_ent_method_model_predictive_control
...
description:
  en: Karush-Kuhn-Tucker (KKT) Conditions mentions Model Predictive Control (MPC).
  zh: Karush-Kuhn-Tucker（KKT）条件提及模型预测控制（MPC）。
verification:
  status: unverified
  reviewed_by: ai
