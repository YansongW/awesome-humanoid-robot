---
$id: rel_ent_paper_pilot_a_perceptive_integrated_2026_is_based_on_ent_qp_standard_form
...
source:
  ...
  name:
    en: 'PILOT: A Perceptive Integrated Low-level Controller for Loco-manipulation
...
description:
  en: 'PILOT: A Perceptive Integrated Low-level Controller for Loco-manipulation over
    Unstructured Scenes is based on or uses Standard Quadratic Program (QP).'
  zh: ''
  ko: ''
verification:
