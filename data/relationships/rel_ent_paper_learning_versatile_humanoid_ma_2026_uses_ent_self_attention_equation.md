---
$id: rel_ent_paper_learning_versatile_humanoid_ma_2026_uses_ent_self_attention_equation
...
description:
  en: Learning Versatile Humanoid Manipulation with Touch Dreaming uses or builds
    on Scaled Dot-Product Self-Attention.
  zh: ''
  ko: ''
verification:
