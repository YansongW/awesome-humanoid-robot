---
$id: rel_ent_method_fea_finite_element_analysis_analyzes_ent_robot_unitree_h1_humanoid_robot_2024
...
domains:
  ...
  - 02_components
description:
  en: FEA analyzes Unitree H1 structural and thermal behavior before prototyping.
...
verification:
  ...
  notes: 'bulk-added confidence on 2026-07-17 by backfill_rel_confidence.py; pending human review | WP4 2026-08-11: endpoint
    id rewritten (ent_method_fea_finite_element_analysis→ent_method_fea_finite_element_analysis, ent_robot_unitree_h1_humanoid_robot_2024→ent_robot_unitree_h1_humanoid_robot_2024);
    original file rel_ent_paper_finite_element_analysis_2024_analyzes_ent_robot_unitree_h1_humanoid_robot_2024.'
