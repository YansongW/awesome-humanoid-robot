---
$id: rel_ent_paper_song_avi_action_from_volumetric_inf_2025_uses_ent_method_behavior_cloning
...
description:
  en: 'Avi: Action from Volumetric Inference uses Behavior Cloning.'
  zh: Avi使用行为克隆。
verification:
  ...
  confidence: medium
  notes: 'Mined by build_latent_relationships.py rule p6_llm_link. Evidence: 该论文的VLA模型通常使用行为克隆方法进行训练'
sources:
- id: src_001
  type: other
