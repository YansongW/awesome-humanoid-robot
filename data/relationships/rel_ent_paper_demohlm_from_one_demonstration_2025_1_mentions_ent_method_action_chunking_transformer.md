---
$id: rel_ent_paper_demohlm_from_one_demonstration_2025_1_mentions_ent_method_action_chunking_transformer
...
description:
  en: 'DemoHLM: From One Demonstration to Generalizable Humanoid Loco-Manipulation mentions Action Chunking with Transformers
    (ACT).'
  zh: DemoHLM｜从单一示范到通用人形移动操作提及动作分块变压器（ACT）。
verification:
  status: unverified
  reviewed_by: ai
