---
$id: rel_ent_process_p1_mentions_ent_process_p16
...
description:
  en: Requirements Definition and System Design (Concept / Pre-A) mentions Pilot & Production Ramp.
  zh: 需求定义与系统方案（Concept / Pre-A）提及小批量试产与量产准备（Pilot & Production Ramp）。
verification:
  status: unverified
  reviewed_by: ai
