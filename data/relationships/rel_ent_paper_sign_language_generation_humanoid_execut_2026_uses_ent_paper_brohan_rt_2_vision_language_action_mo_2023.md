---
$id: rel_ent_paper_sign_language_generation_humanoid_execut_2026_uses_ent_paper_brohan_rt_2_vision_language_action_mo_2023
...
verification:
  ...
  confidence: medium
  notes: 'Mined by build_latent_relationships.py rule p6_llm_link. Evidence: 论文使用视觉语言模型进行手语生成和重定向。 | WP4 2026-08-11: endpoint
    id rewritten (ent_paper_sign_language_generation_humanoid_execut_2026→ent_paper_sign_language_generation_humanoid_execut_2026,
    ent_paper_brohan_rt_2_vision_language_action_mo_2023→ent_paper_brohan_rt_2_vision_language_action_mo_2023); original file rel_ent_paper_sign_language_generation_humanoid_execut_2026_uses_ent_paper_rt_2_vision_language_action_mo_2023.'
sources:
- id: src_001
  type: other
