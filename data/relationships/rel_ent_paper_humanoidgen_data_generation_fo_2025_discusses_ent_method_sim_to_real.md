---
$id: rel_ent_paper_humanoidgen_data_generation_fo_2025_discusses_ent_method_sim_to_real
...
description:
  en: 'HumanoidGen: Data Generation for Bimanual Dexterous Manipulation via LLM Reasoning discusses Sim-to-Real Transfer.'
  zh: 'HumanoidGen: Data Generation for Bimanual Dexterous Manipulation via LLM ReasoningdiscussesSim-to-Real迁移。'
verification:
  status: partially_verified
  reviewed_by: ai
  reviewed_at: '2026-07-16'
  confidence: medium
  notes: 'Mined by build_latent_relationships.py rule p6_llm_link. Evidence: 生成的数据可能用于仿真训练并迁移到真实世界。'
sources:
- id: src_001
  type: other
