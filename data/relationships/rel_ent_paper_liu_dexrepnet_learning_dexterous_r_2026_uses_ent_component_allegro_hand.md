---
$id: rel_ent_paper_liu_dexrepnet_learning_dexterous_r_2026_uses_ent_component_allegro_hand
...
description:
  en: The Allegro Hand is used for real-world deployment of grasp policies.
  zh: Allegro Hand用于真实世界抓取策略部署。
  ko: Allegro Hand는 실제 환경 파지 정책 배포에 사용됨.
verification:
  status: partially_verified
  reviewed_by: ai
  reviewed_at: '2026-06-27'
  confidence: medium
  notes: 'Proposed by AI extraction. Source citation: Abstract states grasp policies are deployed to the real world; metadata
    lists Allegro Hand as a component.'
sources:
- id: src_001
  type: paper
