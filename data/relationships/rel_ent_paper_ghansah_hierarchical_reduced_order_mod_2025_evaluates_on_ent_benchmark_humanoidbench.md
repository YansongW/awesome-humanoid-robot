---
$id: rel_ent_paper_ghansah_hierarchical_reduced_order_mod_2025_evaluates_on_ent_benchmark_humanoidbench
...
description:
  en: Hierarchical Reduced-Order Model Predictive Control for Robust Locomotion on
    Humanoid Robots evaluates or benchmarks HumanoidBench.
  zh: ''
  ko: ''
verification:
