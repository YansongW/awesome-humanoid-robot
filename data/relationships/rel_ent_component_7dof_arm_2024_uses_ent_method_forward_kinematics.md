---
$id: rel_ent_component_7dof_arm_2024_uses_ent_method_forward_kinematics
...
description:
  en: 7-DoF Robotic Arm uses Forward Kinematics.
  zh: 七自由度机械臂使用正运动学。
verification:
  status: unverified
  reviewed_by: ai
  ...
  confidence: low
  notes: 'Mined by build_latent_relationships.py rule p6_llm_link_retry. Evidence: 7自由度机械臂的运动学建模使用正向运动学。'
sources:
- id: src_001
  type: other
