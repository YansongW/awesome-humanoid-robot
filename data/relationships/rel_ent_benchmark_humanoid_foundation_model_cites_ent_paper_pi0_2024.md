---
$id: "rel_ent_benchmark_humanoid_foundation_model_cites_ent_paper_pi0_2024"
...
description:
  en: "The Humanoid Foundation Model Benchmark directory lists and rates π0 as one of the evaluated VLA models."
  zh: "人形机器人基础模型基准目录将 π0 列为参评的 VLA 模型之一并进行评级。"
  ko: "휴리노이드 파울데이션 모델 벤치마크 디렉토리는 π0를 평가된 VLA 모델 중 하나로 나열하고 등급을 매김."
...
verification:
  ...
  confidence: "medium"
  notes: "The benchmark page lists π0 among evaluated models; exact rating methodology is not independently verified."
