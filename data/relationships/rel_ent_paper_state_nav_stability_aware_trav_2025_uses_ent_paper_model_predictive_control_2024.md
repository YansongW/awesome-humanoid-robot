---
$id: rel_ent_paper_state_nav_stability_aware_trav_2025_uses_ent_paper_model_predictive_control_2024
...
description:
  en: 'STATE-NAV: Stability-Aware Traversability Estimation for Bipedal Navigation on Rough Terrain uses Model Predictive
    Control.'
  zh: 'STATE-NAV: Stability-Aware Traversability Estimation for Bipedal Navigation on Rough Terrain使用模型预测控制。'
verification:
