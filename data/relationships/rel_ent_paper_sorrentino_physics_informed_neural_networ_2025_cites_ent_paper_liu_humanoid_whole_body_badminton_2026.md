---
$id: rel_ent_paper_sorrentino_physics_informed_neural_networ_2025_cites_ent_paper_liu_humanoid_whole_body_badminton_2026
...
description:
  en: Physics-Informed Neural Networks with Unscented Kalman Filter for Sensorless
    ...
    Badminton via Multi-Stage Reinforcement Learning.
  zh: ''
  ko: ''
verification:
