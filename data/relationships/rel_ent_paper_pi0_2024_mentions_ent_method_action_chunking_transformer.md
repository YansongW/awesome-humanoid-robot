---
$id: rel_ent_paper_pi0_2024_mentions_ent_method_action_chunking_transformer
...
description:
  en: 'π0: A Vision-Language-Action Flow Model for General Robot Control mentions Action Chunking with Transformers (ACT).'
  zh: π0：用于通用机器人控制的视觉-语言-动作流模型提及动作分块变压器（ACT）。
verification:
  status: unverified
  reviewed_by: ai
