---
$id: rel_ent_process_p16_1_1_uses_ent_method_design_for_manufacturing
...
verification:
  ...
  notes: 'Mined by build_latent_relationships.py rule p3_llm_typed. Evidence: 证据表明DFM/DFA review使用Design for Manufacturing作为方法/工具。
    | 证据: **Method/Tool**: Design for Manufacturing/Assembly Analysis, Assembly Time Estimation | WP4 2026-08-11: endpoint
    id rewritten (ent_process_p16_1_1→ent_process_p16_1_1, ent_method_design_for_manufacturing→ent_method_design_for_manufacturing);
    original file rel_ent_process_p16_1_1_uses_ent_paper_design_for_manufacturing_2024.'
sources:
- id: src_001
  type: other
