---
$id: rel_ent_paper_humanoidmimicgen_data_generati_2026_mentions_ent_method_action_chunking_transformer
...
description:
  en: 'HumanoidMimicGen: Data Generation for Loco-Manipulation via Whole-Body Planning mentions Action Chunking with Transformers
    (ACT).'
  zh: HumanoidMimicGen｜通过全身规划进行移动操作的数据生成提及动作分块变压器（ACT）。
verification:
  status: unverified
  reviewed_by: ai
