---
$id: rel_ent_paper_reinforcement_learning_with_da_2026_uses_ent_method_model_predictive_control
...
description:
  en: Reinforcement Learning with Data Bootstrapping for Dynamic Subgoal Pursuit in Humanoid Robot Navigation uses Model Predictive
    Control (MPC).
  zh: Reinforcement Learning with Data Bootstrapping for Dynamic Subgoal Pursuit in Humanoid Robot Navigation使用模型预测控制（MPC）。
verification:
