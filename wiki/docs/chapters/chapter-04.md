...
> 表：Nd-Fe-B 第二象限退磁曲线示意。高温曲线膝点明显内移，高温工况需保留更大退磁裕量。
...
| C/P | 球轴承 L₁₀ [百万转] (p=3) | 滚子轴承 L₁₀ [百万转] (p=10/3) |
|-----|---------------------------|--------------------------------|
| 1   | 1.0                       | 1.0                            |
| 2   | 8.0                       | 10.0                           |
| 3   | 27.0                      | 32.0                           |
...
> 表：轴承额定寿命随载荷比 C/P 的变化，滚子轴承寿命对载荷比更敏感。
...
> 表：Stribeck 摩擦曲线示意。低速区静摩擦高，进入混合润滑后摩擦系数迅速下降，流体动力润滑区摩擦系数低且稳定。
...
> 表：减速器扭矩-转角滞回曲线示意。加载与卸载曲线不重合，包围面积为每周期耗散的能量；过零点附近空程为背隙。
...
MIT Cheetah 系列四足机器人是 QDD 的代表：Wensing 等人 2017 年报道的 Cheetah 关节采用定制无框电机 + 单级行星减速器，能够实现高动态奔跑与落地冲击缓冲[2]。Seok 等 2015 年进一步总结了能效腿式机器人的设计原则，指出低减速比与轻量腿部是高速动态运动的关键[4]。
...
> 表：执行器 Pareto 前沿示意。随质量增加扭矩密度下降趋缓，工程上常选取膝点（约 2 kg）以平衡质量与扭矩密度。
