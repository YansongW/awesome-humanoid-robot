# SEW-EURODRIVE PS.F / PS.C 行星伺服减速电机 / SEW-EURODRIVE PS.F / PS.C Planetary Servo Gearmotor
...
| 项目 | 内容 |
|------|------|
| **制造商** | [SEW-EURODRIVE（赛威传动） / SEW-EURODRIVE](../companies/company_sew_eurodrive.md) |
| **产品类别** | 行星伺服减速电机 |
| **发布时间** | 现役主力型号 |
| **状态** | 量产/商用 |
