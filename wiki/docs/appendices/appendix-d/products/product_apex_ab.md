...
| 项目 | 内容 |
|------|------|
| **制造商** | [精锐科技（Apex Dynamics） / Apex Dynamics](../companies/company_apex_dynamics.md) |
| **产品类别** | 高精度行星减速器 |
| **发布时间** | 现役主力型号 |
| **状态** | 量产/商用 |
...
> Apex Dynamics AB 系列高精度行星减速器 / Apex Dynamics AB Series Planetary Gearbox：请访问 [官方资料](https://www.apexdynamics.com) 查看。
