---
id: ent_product_molex_micro_fit_3
schema_version: 1
type: product
...
names:
  zh: Molex Micro-Fit 3.0 连接器系统
  en: Molex Micro-Fit 3.0 连接器系统
status: active
sources:
- id: src_product_molex_micro_fit_3_official
  type: website
...
# Molex Micro-Fit 3.0 连接器系统 / Molex Micro-Fit 3.0 连接器系统
