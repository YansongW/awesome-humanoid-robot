---
id: ent_product_mitsubishi_iq_r
schema_version: 1
type: product
'title:': Mitsubishi Electric MELSEC iQ-R R04CPU
...
status: active
sources:
- id: ent_product_mitsubishi_iq_r_official
  type: website
  url: https://www.mitsubishielectric.com/fa/products/cnt/plc/r/r04cpu.html
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [三菱电机 / Mitsubishi Electric](../../../appendices/appendix-d/companies/company_mitsubishi_electric.md) |
| **产品类别** | 可编程逻辑控制器（PLC） |
...
> Mitsubishi Electric MELSEC iQ-R R04CPU：请访问 [官方资料](https://www.mitsubishielectric.com/fa/products/cnt/plc/r/r04cpu.html) 查看。
