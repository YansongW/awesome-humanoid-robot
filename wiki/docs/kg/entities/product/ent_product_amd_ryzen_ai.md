...
status: active
sources:
- id: src_ent_product_amd_ryzen_ai_official
  type: website
  url: https://www.amd.com/en/processors/ryzen-ai
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [AMD / Advanced Micro Devices](../../../appendices/appendix-d/companies/company_amd.md) |
...
> AMD Ryzen AI：请访问 [官方资料](https://www.amd.com/en/processors/ryzen-ai) 查看。
