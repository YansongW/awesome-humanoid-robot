---
id: ent_product_honeywell_control_edge
schema_version: 1
type: product
'title:': Honeywell ControlEdge PLC
...
status: active
sources:
- id: ent_product_honeywell_control_edge_official
  type: website
  url: https://process.honeywell.com/us/en/products/control-edge-plc
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [霍尼韦尔 / Honeywell](../../../appendices/appendix-d/companies/company_honeywell.md) |
| **产品类别** | 可编程逻辑控制器（PLC） |
| **发布时间** | 2016 年 |
| **状态** | 量产/商用 |
...
> Honeywell ControlEdge PLC：请访问 [官方资料](https://process.honeywell.com/us/en/products/control-edge-plc) 查看。
