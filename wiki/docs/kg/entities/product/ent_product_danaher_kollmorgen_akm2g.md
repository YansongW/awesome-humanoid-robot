---
id: ent_product_danaher_kollmorgen_akm2g
schema_version: 1
type: product
'title:': Kollmorgen AKM2G 伺服电机
...
status: active
sources:
- id: ent_product_danaher_kollmorgen_akm2g_official
  type: website
  url: https://www.kollmorgen.com/en-us/products/motors/servo-motors/akm2g-servo-motors
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [丹纳赫（Kollmorgen） / Danaher（Kollmorgen）](../../../appendices/appendix-d/companies/company_danaher.md) |
| **产品类别** | 伺服电机 |
| **发布时间** | 2018 年 |
| **状态** | 量产/商用 |
...
> Kollmorgen AKM2G 伺服电机：请访问 [官方资料](https://www.kollmorgen.com/en-us/products/motors/servo-motors/akm2g-servo-motors) 查看。
