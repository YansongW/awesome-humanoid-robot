---
id: ent_product_omron_nj501
schema_version: 1
type: product
'title:': OMRON NJ501 Sysmac 控制器
...
status: active
sources:
- id: ent_product_omron_nj501_official
  type: website
  url: https://www.omron.com.cn/products/family/3194/
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [欧姆龙 / OMRON](../../../appendices/appendix-d/companies/company_omron.md) |
| **产品类别** | 机器自动化控制器（MAC） |
| **发布时间** | 2011 年起（现役主力型号） |
| **状态** | 量产/商用 |
...
> OMRON NJ501 Sysmac 控制器：请访问 [官方资料](https://www.omron.com.cn/products/family/3194/) 查看。
