---
id: ent_product_jst_ph
schema_version: 1
type: product
'title:': JST PH 系列 2.0 mm 线对板连接器
domain: 02_components
theoretical_depth: system
names:
  zh: JST PH 系列 2.0 mm 线对板连接器
  en: JST PH 系列 2.0 mm 线对板连接器
status: active
sources:
- id: src_product_jst_ph_official
  type: website
...
# JST PH 系列 2.0 mm 线对板连接器 / JST PH 系列 2.0 mm 线对板连接器
...
| 项目 | 内容 |
|------|------|
| **制造商** | [日本压着端子制造 / J.S.T.](../../../appendices/appendix-d/companies/company_jst.md) |
| **产品类别** | 2.0 mm 线对板连接器 |
| **发布时间** | 现役在售 |
| **状态** | 量产/商用 |
