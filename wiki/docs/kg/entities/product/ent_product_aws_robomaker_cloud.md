---
id: ent_product_aws_robomaker_cloud
schema_version: 1
type: product
domain: 11_applications_markets
theoretical_depth: system
names:
  zh: AWS RoboMaker 云机器人平台
  en: AWS RoboMaker Cloud Robotics Platform
status: active
sources:
- id: src_ent_product_aws_robomaker_cloud
  type: website
  url: ''
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [AWS RoboMaker](../../../appendices/appendix-d/companies/company_aws_robomaker.md) |
