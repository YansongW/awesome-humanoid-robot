---
id: ent_product_festo_bionicsoftarm
type: product
'title:': Festo BionicSoftArm 气动柔性协作臂
...
sources:
- id: festo_bionicsoftarm_page
  type: website
  url: https://www.festo.com/de/en/e/bionicsoftarm.html
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [费斯托 / Festo SE & Co. KG](../../../appendices/appendix-d/companies/company_festo.md) |
| **产品类别** | 气动柔性协作臂 |
| **发布时间** | 2019 年 |
| **状态** | 发布/商用 |
...
> BionicSoftArm：请访问 [官方资料](https://www.festo.com/de/en/e/bionicsoftarm.html) 查看。
