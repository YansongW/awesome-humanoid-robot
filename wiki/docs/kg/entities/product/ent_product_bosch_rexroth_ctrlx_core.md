---
id: ent_product_bosch_rexroth_ctrlx_core
schema_version: 1
type: product
'title:': Bosch Rexroth ctrlX CORE
...
status: active
sources:
- id: ent_product_bosch_rexroth_ctrlx_core_official
  type: website
  url: https://www.boschrexroth.com/en/us/products/product-groups/controls/ctrlx-automation/ctrlx-core
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [博世力士乐 / Bosch Rexroth](../../../appendices/appendix-d/companies/company_bosch_rexroth.md) |
| **产品类别** | 工业自动化控制器 |
| **发布时间** | 2020 年 |
| **状态** | 量产/商用 |
...
> Bosch Rexroth ctrlX CORE：请访问 [官方资料](https://www.boschrexroth.com/en/us/products/product-groups/controls/ctrlx-automation/ctrlx-core) 查看。
