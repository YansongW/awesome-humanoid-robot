---
id: ent_product_google_cloud_robotics_platform
schema_version: 1
type: product
domain: 11_applications_markets
theoretical_depth: system
names:
  zh: Google Cloud Robotics 平台
  en: Google Cloud Robotics Platform
status: active
sources:
- id: src_ent_product_google_cloud_robotics_platform
  type: website
  url: ''
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [Google Cloud Robotics](../../../appendices/appendix-d/companies/company_google_cloud_robotics.md) |
