---
id: ent_product_rockwell_automation
type: product
'title:': 罗克韦尔自动化 Integrated Architecture / ControlLogix
...
sources:
- id: rockwell_automation_page
  type: website
  url: https://www.rockwellautomation.com/en-us/products/hardware/allen-bradley/controllers/programmable-automation-controllers.html
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [罗克韦尔自动化 / Rockwell Automation, Inc.](../../../appendices/appendix-d/companies/company_rockwell.md) |
...
> ControlLogix 5580：请访问 [官方资料](https://www.rockwellautomation.com/en-us/products/hardware/allen-bradley/controllers/programmable-automation-controllers.html) 查看。
