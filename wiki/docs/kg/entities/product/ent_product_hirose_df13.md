...
names:
  zh: Hirose DF13 1.25 mm 线对板连接器
  en: Hirose DF13 1.25 mm 线对板连接器
status: active
sources:
- id: src_product_hirose_df13_official
  type: website
...
# Hirose DF13 1.25 mm 线对板连接器 / Hirose DF13 1.25 mm 线对板连接器
