---
id: ent_product_syntouch_biotac
schema_version: 1
type: product
domain: 11_applications_markets
theoretical_depth: system
names:
  zh: SynTouch BioTac 仿生触觉传感器
  en: SynTouch BioTac Biomimetic Tactile Sensor
status: active
sources:
...
# SynTouch BioTac 仿生触觉传感器 / SynTouch BioTac Biomimetic Tactile Sensor
