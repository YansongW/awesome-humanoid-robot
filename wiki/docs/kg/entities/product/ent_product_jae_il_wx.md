...
names:
  zh: JAE IL-WX 1.25 mm 线对板连接器
  en: JAE IL-WX 1.25 mm 线对板连接器
status: active
sources:
- id: src_product_jae_il_wx_official
  type: website
...
# JAE IL-WX 1.25 mm 线对板连接器 / JAE IL-WX 1.25 mm 线对板连接器
