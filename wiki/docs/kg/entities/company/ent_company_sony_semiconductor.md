---
id: ent_company_sony_semiconductor
schema_version: 1
type: company
domain: 02_components
theoretical_depth: system
names:
  zh: 索尼半导体解决方案（Sony Semiconductor Solutions）
  en: Sony Semiconductor Solutions
status: active
sources:
- id: src_ent_company_sony_semiconductor_official
  type: website
  url: https://www.sony-semicon.co.jp
verification:
