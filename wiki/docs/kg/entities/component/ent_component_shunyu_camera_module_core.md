---
id: ent_component_shunyu_camera_module_core
type: component
'title:': Sunny Optical Automotive / Robot Camera Module Core Component
domain: 02_components
theoretical_depth: system
aliases:
- 舜宇光学车载/机器人摄像头模组 核心零部件
status: active
created_at: 2026-07-01 00:00:00+00:00
updated_at: 2026-07-09 00:00:00+00:00
sources:
- id: ent_component_shunyu_camera_module_core_official
  type: website
...
| 项目 | 内容 |
|------|------|
| **制造商** | [舜宇光学 / Sunny Optical](../../../appendices/appendix-d/companies/company_shunyu.md) |
| **产品类别** | 车规级摄像头模组 |
| **发布时间** | 持续在售/迭代 |
| **状态** | 量产/商用 |
