...
names:
  zh: 信捷 DS5 系列伺服驱动器
  en: Xinje DS5 Servo Drive
status: active
sources:
- id: src_ent_component_xinje_ds5
  type: website
  url: ''
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [信捷电气 / Xinje Electric](../../../appendices/appendix-d/companies/company_xinje.md) |
| **产品类别** | 伺服驱动器 / 运动控制核心部件 |
| **发布时间** | 2010 年代持续迭代 |
| **状态** | 量产/商用 |
