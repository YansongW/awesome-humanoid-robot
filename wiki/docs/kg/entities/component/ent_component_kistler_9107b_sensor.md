---
id: ent_component_kistler_9107b_sensor
schema_version: 1
type: component
domain: 02_components
theoretical_depth: system
names:
  zh: Kistler 9107B 三分量力传感器 核心传感单元
  en: Kistler 9107B 3-Component Force Sensor Core Sensing Unit
status: active
sources:
- id: src_ent_component_kistler_9107b_sensor_official
  type: website
...
# Kistler 9107B 三分量力传感器 核心传感单元 / Kistler 9107B 3-Component Force Sensor Core Sensing Unit
