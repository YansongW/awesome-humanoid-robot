---
id: ent_component_xela_uskin_module
schema_version: 1
type: component
domain: 11_applications_markets
theoretical_depth: component
names:
  zh: XELA uSkin 三轴力传感单元
  en: XELA uSkin 3-Axis Force Sensing Taxel
status: active
sources:
- id: src_xela_official
  type: website
  url: https://www.xelarobotics.com
verification:
...
# XELA uSkin 三轴力传感单元 / XELA uSkin 3-Axis Force Sensing Taxel
...
| 项目 | 内容 |
|------|------|
| **制造商** | [XELA Robotics](../../../appendices/appendix-d/companies/company_xela.md) |
