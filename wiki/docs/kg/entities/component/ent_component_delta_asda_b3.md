---
id: ent_component_delta_asda_b3
schema_version: 1
type: component
domain: 11_applications_markets
theoretical_depth: system
names:
  zh: 台达 ASDA-B3 系列伺服驱动器
  en: Delta ASDA-B3 Servo Drive
status: active
sources:
- id: src_ent_component_delta_asda_b3
  type: website
  url: ''
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [台达电子 / Delta Electronics](../../../appendices/appendix-d/companies/company_delta_electronics.md) |
| **产品类别** | 伺服驱动器 / 运动控制核心部件 |
| **发布时间** | 2020 年代持续迭代 |
| **状态** | 量产/商用 |
