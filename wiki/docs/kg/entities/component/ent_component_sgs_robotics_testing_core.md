---
id: ent_component_sgs_robotics_testing_core
schema_version: 1
type: component
domain: 04_assembly_integration_testing
theoretical_depth: system
names:
  zh: SGS 机器人检测认证核心服务模块
  en: SGS Robotics Testing and Certification Core Service Module
status: active
sources:
- id: src_ent_component_sgs_robotics_testing_core_official
  type: website
...
# SGS 机器人检测认证核心服务模块 / SGS Robotics Testing and Certification Core Service Module
...
| 项目 | 内容 |
|------|------|
| **制造商** | [SGS / 瑞士通用公证行](../../../appendices/appendix-d/companies/company_sgs.md) |
