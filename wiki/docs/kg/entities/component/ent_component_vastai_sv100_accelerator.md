---
id: ent_component_vastai_sv100_accelerator
type: component
'title:': Vastai SV100 Accelerator
...
sources:
- id: ent_component_vastai_sv100_accelerator_official
  type: website
  url: https://www.vastai.com/products.html
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [瀚博半导体 / Vastai Technologies](../../../appendices/appendix-d/companies/company_vastai.md) |
...
> 瀚博半导体 SV100：请访问 [官方资料](https://www.vastai.com/products.html) 查看。
