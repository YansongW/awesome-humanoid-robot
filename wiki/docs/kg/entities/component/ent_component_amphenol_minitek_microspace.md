---
id: ent_component_amphenol_minitek_microspace
schema_version: 1
type: component
'title:': Amphenol Minitek MicroSpace 1.27 mm 线对板连接器
...
status: active
sources:
- id: src_component_amphenol_minitek_microspace_official
  type: website
...
| 项目 | 内容 |
|------|------|
| **制造商** | [安费诺 / Amphenol](../../../appendices/appendix-d/companies/company_amphenol.md) |
| **产品类别** | 1.27 mm 线对板连接器 |
| **发布时间** | 现役在售 |
| **状态** | 量产/商用 |
| **官网/来源** | [Amphenol官网](https://www.amphenol.com) |

## 产品概述

Amphenol Minitek MicroSpace 1.27 mm 线对板连接器 是 安费诺 面向 汽车电子、机器人控制器、传感器接口 推出的 1.27 mm 线对板连接器。该产品以标准化接口、稳定接触与高可靠性的工业级设计，满足机器人系统对信号、电源或数据连接的长期稳定需求。
...
- **制造商**：[安费诺 / Amphenol](../../../appendices/appendix-d/companies/company_amphenol.md)
- **核心零部件/技术来源**：铜合金、高性能塑料、电镀材料、线缆、磁材
- **下游应用/客户**：机器人控制板、电机驱动、BMS、工业控制器、车载 ECU。

## 知识图谱节点与关系

- 产品实体：`ent_product_amphenol_minitek_microspace`
- 零部件实体：`ent_component_amphenol_minitek_microspace`
- 制造商实体：`ent_company_amphenol`
- 关键关系：
...
1. [Amphenol官网](https://www.amphenol.com)
