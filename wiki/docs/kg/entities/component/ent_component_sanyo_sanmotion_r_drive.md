---
id: ent_component_sanyo_sanmotion_r_drive
schema_version: 1
type: component
domain: 11_applications_markets
theoretical_depth: system
names:
  zh: 山洋 SANMOTION R 系列伺服电机
  en: Sanyo Denki SANMOTION R Series Servo Motor
status: active
sources:
- id: src_ent_component_sanyo_sanmotion_r_drive
  type: website
  url: ''
verification:
...
| 项目 | 内容 |
|------|------|
| **制造商** | [山洋电气 / Sanyo Denki](../../../appendices/appendix-d/companies/company_sanyo_denki.md) |
| **产品类别** | 伺服电机 / 精密运动核心部件 |
| **发布时间** | 2010 年代持续迭代 |
| **状态** | 量产/商用 |
