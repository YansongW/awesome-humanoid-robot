---
id: ent_component_himax_slim_3d_module
schema_version: 1
type: component
domain: 02_components
theoretical_depth: system
names:
  zh: Himax SLiM 3D 传感模组 核心传感单元
  en: Himax SLiM 3D Sensing Module Core Sensing Unit
status: active
sources:
- id: src_ent_component_himax_slim_3d_module_official
  type: website
...
# Himax SLiM 3D 传感模组 核心传感单元 / Himax SLiM 3D Sensing Module Core Sensing Unit
