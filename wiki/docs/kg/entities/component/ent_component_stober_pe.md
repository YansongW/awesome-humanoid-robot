---
id: ent_component_stober_pe
schema_version: 1
type: component
'title:': STOBER PE 系列经济型行星减速器
domain: 02_components
theoretical_depth: system
names:
  zh: STOBER PE 系列经济型行星减速器
  en: STOBER PE Series Planetary Gearbox
status: active
sources:
- id: src_stober_stober_pe_official
  type: website
...
| 项目 | 内容 |
|------|------|
| **制造商** | [STOBER（斯多博） / STOBER](../../../appendices/appendix-d/companies/company_stober.md) |
| **产品类别** | 经济型行星减速器 |
| **发布时间** | 现役主力型号 |
| **状态** | 量产/商用 |
